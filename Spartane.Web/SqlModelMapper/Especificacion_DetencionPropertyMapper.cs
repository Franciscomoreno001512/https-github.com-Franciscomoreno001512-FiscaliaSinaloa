...
{
    public class Especificacion_DetencionPropertyMapper : ISqlPropertyMapper
    {
        public string GetPropertyName(string propertyName)
        {
            ...
            {
                case "Clave":
                    return "Especificacion_Detencion.Clave";
                case "Descripcion":
        ...
        {
            var t = (typeof(Especificacion_Detencion).GetProperty(columnName));
