...
{
    public class Detalle_Relaciones_Audiencia_InicialPropertyMapper : ISqlPropertyMapper
    {
        public string GetPropertyName(string propertyName)
        {
            ...
            {
                case "Clave":
                    return "Detalle_Relaciones_Audiencia_Inicial.Clave";
        ...
        {
            var t = (typeof(Detalle_Relaciones_Audiencia_Inicial).GetProperty(columnName));
