...
{
    public class SubArea_de_Servicios_de_ApoyoPropertyMapper : ISqlPropertyMapper
    {
        public string GetPropertyName(string propertyName)
        {
            ...
            {
                case "Clave":
                    return "SubArea_de_Servicios_de_Apoyo.Clave";
                case "Descripcion":
        ...
        {
            var t = (typeof(SubArea_de_Servicios_de_Apoyo).GetProperty(columnName));
