...
{
    public class Detalle_Probable_Responsable_de_DocumentosPropertyMapper : ISqlPropertyMapper
    {
        ...
        {
            var t = (typeof(Detalle_Probable_Responsable_de_Documentos).GetProperty(columnName));
