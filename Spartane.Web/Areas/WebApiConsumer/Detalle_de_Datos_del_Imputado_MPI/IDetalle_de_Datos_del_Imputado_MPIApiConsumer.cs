...
namespace Spartane.Web.Areas.WebApiConsumer.Detalle_de_Datos_del_Imputado_MPI
{
    public interface IDetalle_de_Datos_del_Imputado_MPIApiConsumer
    {
		...
		ApiResponse<int> Update_Datos_de_Media_Filiacion(Spartane.Core.Domain.Detalle_de_Datos_del_Imputado_MPI.Detalle_de_Datos_del_Imputado_MPI_Datos_de_Media_Filiacion entity);
		ApiResponse<Spartane.Core.Domain.Detalle_de_Datos_del_Imputado_MPI.Detalle_de_Datos_del_Imputado_MPI_Datos_de_Media_Filiacion> Get_Datos_de_Media_Filiacion(string Key);
