        ...
        public ActionResult Create(int Id = 0, int consult = 0, int ModuleId = 0)
        {
            ...
            if ((Id.GetType() == typeof(string) && Id.ToString() != "") || ((Id.GetType() == typeof(int) || Id.GetType() == typeof(Int16) || Id.GetType() == typeof(Int32) || Id.GetType() == typeof(Int64) || Id.GetType() == typeof(short)) && Id.ToString() != "0"))
            {
                ...
                if (Dashboard_EditorsData != null && Dashboard_EditorsData.Count > 0)
                {
                    ...
                    ,
                        Registration_UserName = CultureHelper.GetTraduction(Convert.ToString(Dashboard_EditorData.Registration_User), "Spartan_User") ?? (string)Dashboard_EditorData.Registration_User_Spartan_User.Name
                    ,
                        Name = Dashboard_EditorData.Name
                    ,
                        Dashboard_Template = Dashboard_EditorData.Dashboard_Template
                    ,
                        Dashboard_TemplateDescription = CultureHelper.GetTraduction(Convert.ToString(Dashboard_EditorData.Dashboard_Template), "Template_Dashboard_Editor") ?? (string)Dashboard_EditorData.Dashboard_Template_Template_Dashboard_Editor.Description
                    ,
                        Show_in_Home = Dashboard_EditorData.Show_in_Home.GetValueOrDefault()
                    ,
                        Status = Dashboard_EditorData.Status
                    ,
                        StatusDescription = CultureHelper.GetTraduction(Convert.ToString(Dashboard_EditorData.Status), "Dashboard_Status") ?? (string)Dashboard_EditorData.Status_Dashboard_Status.Description
                    ,
        ...
        public ActionResult Get()
        {
            ...
            return Json(new
            {
                data = result.Dashboard_Editors.Select(m => new Dashboard_EditorGridModel
                {
                    ...
                    ,
                    Registration_UserName = CultureHelper.GetTraduction(m.Registration_User_Spartan_User.Id_User.ToString(), "Name") ?? (string)m.Registration_User_Spartan_User.Name
        ,
                    Name = m.Name
                    ,
                    Dashboard_TemplateDescription = CultureHelper.GetTraduction(m.Dashboard_Template_Template_Dashboard_Editor.Template_Id.ToString(), "Description") ?? (string)m.Dashboard_Template_Template_Dashboard_Editor.Description
        ,
                    Show_in_Home = m.Show_in_Home
                    ,
                    StatusDescription = CultureHelper.GetTraduction(m.Status_Dashboard_Status.Status_Id.ToString(), "Description") ?? (string)m.Status_Dashboard_Status.Description
        ,
