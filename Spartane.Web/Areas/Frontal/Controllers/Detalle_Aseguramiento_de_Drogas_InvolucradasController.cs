...
namespace Spartane.Web.Areas.Frontal.Controllers
{
    ...
    public class Detalle_Aseguramiento_de_Drogas_InvolucradasController : Controller
    {
        ...
        // GET: Frontal/Detalle_Aseguramiento_de_Drogas_Involucradas
        [ObjectAuth(ObjectId = (ModuleObjectId)45535, PermissionType = PermissionTypes.Consult)]
        public ActionResult Index()
        {
            var permission = PermissionHelper.GetRoleObjectPermission(SessionHelper.Role, 45535);
            ViewBag.Permission = permission;
            ViewBag.AdvanceSearch = Session["AdvanceSearch"] != null;
            return View();
        }

        // GET: Frontal/Detalle_Aseguramiento_de_Drogas_Involucradas/Create
        [ObjectAuth(ObjectId = (ModuleObjectId)45535, PermissionType = PermissionTypes.New,
        ...
        public ActionResult Create(int Id = 0,  int consult = 0)
        {
            ...
            var permission = PermissionHelper.GetRoleObjectPermission(SessionHelper.Role, 45535);
            ViewBag.Permission = permission;
            var varDetalle_Aseguramiento_de_Drogas_Involucradas = new Detalle_Aseguramiento_de_Drogas_InvolucradasModel();
			
            ViewBag.ObjectId = "45535";
            ...
            if ((Id.GetType() == typeof(string) && Id.ToString() != "") || ((Id.GetType() == typeof(int) || Id.GetType() == typeof(Int16) || Id.GetType() == typeof(Int32) || Id.GetType() == typeof(Int64) || Id.GetType() == typeof(short))&& Id.ToString() != "0"))
            {
                ...
                var Detalle_Aseguramiento_de_Drogas_InvolucradasData = _IDetalle_Aseguramiento_de_Drogas_InvolucradasApiConsumer.GetByKeyComplete(Id).Resource.Detalle_Aseguramiento_de_Drogas_Involucradass[0];
                if (Detalle_Aseguramiento_de_Drogas_InvolucradasData == null)
                    return HttpNotFound();
                ...
                varDetalle_Aseguramiento_de_Drogas_Involucradas = new Detalle_Aseguramiento_de_Drogas_InvolucradasModel
                {
                    ...
                    ,Observaciones = Detalle_Aseguramiento_de_Drogas_InvolucradasData.Observaciones
            ...
            if (Unidad_de_medida_de_tipo_de_drogas_Unidad_de_Medida != null && Unidad_de_medida_de_tipo_de_drogas_Unidad_de_Medida.Resource != null)
                ViewBag.Unidad_de_medida_de_tipo_de_drogas_Unidad_de_Medida = Unidad_de_medida_de_tipo_de_drogas_Unidad_de_Medida.Resource.Where(m => m.Descripcion != null).OrderBy(m => m.Descripcion).Select(m => new SelectListItem
                {
                    Text = CultureHelper.GetTraduction(Convert.ToString(m.Clave), "Unidad_de_medida_de_tipo_de_droga", "Descripcion") ?? m.Descripcion.ToString(), Value = Convert.ToString(m.Clave)
                }).ToList();
            ...
            return View(varDetalle_Aseguramiento_de_Drogas_Involucradas);
        }
		
	[HttpGet]
        public ActionResult AddDetalle_Aseguramiento_de_Drogas_Involucradas(int rowIndex = 0, int functionMode = 0, int id = 0)
        {
            int ModuleId = (Session["CurrentModuleId"] != null) ? Convert.ToInt32(Session["CurrentModuleId"]) : 0;
			...
			if (!_tokenManager.GenerateToken())
                return null;
           _IDetalle_Aseguramiento_de_Drogas_InvolucradasApiConsumer.SetAuthHeader(_tokenManager.Token);
			Detalle_Aseguramiento_de_Drogas_InvolucradasModel varDetalle_Aseguramiento_de_Drogas_Involucradas= new Detalle_Aseguramiento_de_Drogas_InvolucradasModel();


            if (id.ToString() != "0")
            {
                var Detalle_Aseguramiento_de_Drogas_InvolucradassData = _IDetalle_Aseguramiento_de_Drogas_InvolucradasApiConsumer.ListaSelAll(0, 1000, "Detalle_Aseguramiento_de_Drogas_Involucradas.Clave=" + id, "").Resource.Detalle_Aseguramiento_de_Drogas_Involucradass;
				
				if (Detalle_Aseguramiento_de_Drogas_InvolucradassData != null && Detalle_Aseguramiento_de_Drogas_InvolucradassData.Count > 0)
                {
					var Detalle_Aseguramiento_de_Drogas_InvolucradasData = Detalle_Aseguramiento_de_Drogas_InvolucradassData.First();
					varDetalle_Aseguramiento_de_Drogas_Involucradas= new Detalle_Aseguramiento_de_Drogas_InvolucradasModel
					{
            ...
            return PartialView("AddDetalle_Aseguramiento_de_Drogas_Involucradas", varDetalle_Aseguramiento_de_Drogas_Involucradas);
        }
        ...
        public ActionResult GetUnidad_de_medida_de_tipo_de_drogaAll()
        {
            try
            {
                ...
                return Json(result.OrderBy(m => m.Descripcion).Select(m => new SelectListItem
                {
                     Text = CultureHelper.GetTraduction(Convert.ToString(m.Clave), "Unidad_de_medida_de_tipo_de_droga", "Descripcion")?? m.Descripcion,
                    Value = Convert.ToString(m.Clave)
                }).ToArray(), JsonRequestBehavior.AllowGet);
            }
            catch (ServiceException ex)
        ...
        public ActionResult Get()
        {
            ...
            if (filter != null)
                configuration = GridQueryHelper.GetConfiguration(filter, new Detalle_Aseguramiento_de_Drogas_InvolucradasPropertyMapper());

            var pageSize = Convert.ToInt32(filter["pageSize"]);
            var pageIndex = Convert.ToInt32(filter["pageIndex"]);
            var result = _IDetalle_Aseguramiento_de_Drogas_InvolucradasApiConsumer.ListaSelAll((pageIndex * pageSize) - pageSize + 1, pageSize, configuration.WhereClause, configuration.OrderByClause ?? "").Resource;
        ...
        public ActionResult Delete(int id)
        {
            try
            {
                ...
                Detalle_Aseguramiento_de_Drogas_Involucradas varDetalle_Aseguramiento_de_Drogas_Involucradas = null;
                if (id.ToString() != "0")
                {
                        string where = "";

                }
                var result = _IDetalle_Aseguramiento_de_Drogas_InvolucradasApiConsumer.Delete(id, null, null).Resource;
        ...
        [HttpPost]
        public ActionResult Post(bool IsNew, Detalle_Aseguramiento_de_Drogas_InvolucradasModel varDetalle_Aseguramiento_de_Drogas_Involucradas)
        {
            try
            {
				if (ModelState.IsValid)
				{
                    ...
                    result = !IsNew ?
                        _IDetalle_Aseguramiento_de_Drogas_InvolucradasApiConsumer.Update(Detalle_Aseguramiento_de_Drogas_InvolucradasInfo, null, null).Resource.ToString() :
                         _IDetalle_Aseguramiento_de_Drogas_InvolucradasApiConsumer.Insert(Detalle_Aseguramiento_de_Drogas_InvolucradasInfo, null, null).Resource.ToString();
        ...
        /// <summary>
        /// Write Element Array of Detalle_Aseguramiento_de_Drogas_Involucradas script
        /// </summary>
        /// <param name="oDetalle_Aseguramiento_de_Drogas_InvolucradasElements"></param>
        /// <returns></returns>
        [HttpPost]
        public JsonResult WriteScriptSettings(CustomElements Detalle_Aseguramiento_de_Drogas_InvolucradasModuleAttributeList)
        {
            for (int i = 0; i < Detalle_Aseguramiento_de_Drogas_InvolucradasModuleAttributeList.CustomModuleAttributeList.Count - 1; i++)
            {
                if (string.IsNullOrEmpty(Detalle_Aseguramiento_de_Drogas_InvolucradasModuleAttributeList.CustomModuleAttributeList[i].DefaultValue))
                {
                    Detalle_Aseguramiento_de_Drogas_InvolucradasModuleAttributeList.CustomModuleAttributeList[i].DefaultValue = string.Empty;
                }
                if (string.IsNullOrEmpty(Detalle_Aseguramiento_de_Drogas_InvolucradasModuleAttributeList.CustomModuleAttributeList[i].HelpText))
                {
                    Detalle_Aseguramiento_de_Drogas_InvolucradasModuleAttributeList.CustomModuleAttributeList[i].HelpText = string.Empty;
                }
            }
			if (Detalle_Aseguramiento_de_Drogas_InvolucradasModuleAttributeList.ChildModuleAttributeList != null)
            {
				for (int i = 0; i < Detalle_Aseguramiento_de_Drogas_InvolucradasModuleAttributeList.ChildModuleAttributeList.Count - 1; i++)
				{
					if (string.IsNullOrEmpty(Detalle_Aseguramiento_de_Drogas_InvolucradasModuleAttributeList.ChildModuleAttributeList[i].DefaultValue))
					{
						Detalle_Aseguramiento_de_Drogas_InvolucradasModuleAttributeList.ChildModuleAttributeList[i].DefaultValue = string.Empty;
					}
					if (string.IsNullOrEmpty(Detalle_Aseguramiento_de_Drogas_InvolucradasModuleAttributeList.ChildModuleAttributeList[i].HelpText))
					{
						Detalle_Aseguramiento_de_Drogas_InvolucradasModuleAttributeList.ChildModuleAttributeList[i].HelpText = string.Empty;
					}
				}
			}
            string strDetalle_Aseguramiento_de_Drogas_InvolucradasScript = string.Empty;
            using (StreamReader r = new StreamReader(Server.MapPath("~/Uploads/Scripts/Detalle_Aseguramiento_de_Drogas_Involucradas.js")))
            {
                strDetalle_Aseguramiento_de_Drogas_InvolucradasScript = r.ReadToEnd();
            }

            JavaScriptSerializer jsSerialize = new JavaScriptSerializer();

            // get json string of change Detalle_Aseguramiento_de_Drogas_Involucradas element attributes
            string userChangeJson = jsSerialize.Serialize(Detalle_Aseguramiento_de_Drogas_InvolucradasModuleAttributeList.CustomModuleAttributeList);

            int indexOfArray = strDetalle_Aseguramiento_de_Drogas_InvolucradasScript.IndexOf("inpuElementArray");
            string splittedString = strDetalle_Aseguramiento_de_Drogas_InvolucradasScript.Substring(indexOfArray, strDetalle_Aseguramiento_de_Drogas_InvolucradasScript.Length - indexOfArray);
            int indexOfMainElement = splittedString.IndexOf('[');
            int endIndexOfMainElement = splittedString.IndexOf(']') + 1;

            // get json string of change job history element attributes
            string childUserChangeJson = jsSerialize.Serialize(Detalle_Aseguramiento_de_Drogas_InvolucradasModuleAttributeList.ChildModuleAttributeList);
			...
			if (Detalle_Aseguramiento_de_Drogas_InvolucradasModuleAttributeList.ChildModuleAttributeList != null)
            {
				indexOfArrayHistory = strDetalle_Aseguramiento_de_Drogas_InvolucradasScript.IndexOf("inpuElementChildArray");
				splittedStringHistory = strDetalle_Aseguramiento_de_Drogas_InvolucradasScript.Substring(indexOfArrayHistory, strDetalle_Aseguramiento_de_Drogas_InvolucradasScript.Length - indexOfArrayHistory);
				indexOfMainElementHistory = splittedStringHistory.IndexOf('[');
				endIndexOfMainElementHistory = splittedStringHistory.IndexOf(']') + 1;
			}
			string finalResponse = strDetalle_Aseguramiento_de_Drogas_InvolucradasScript.Substring(0, indexOfArray + indexOfMainElement) + userChangeJson + strDetalle_Aseguramiento_de_Drogas_InvolucradasScript.Substring(endIndexOfMainElement + indexOfArray, strDetalle_Aseguramiento_de_Drogas_InvolucradasScript.Length - (endIndexOfMainElement + indexOfArray));
            if (Detalle_Aseguramiento_de_Drogas_InvolucradasModuleAttributeList.ChildModuleAttributeList != null)
            {
				finalResponse = strDetalle_Aseguramiento_de_Drogas_InvolucradasScript.Substring(0, indexOfArray + indexOfMainElement) + userChangeJson
                + strDetalle_Aseguramiento_de_Drogas_InvolucradasScript.Substring(endIndexOfMainElement + indexOfArray, (indexOfMainElementHistory + indexOfArrayHistory) - (endIndexOfMainElement + indexOfArray)) + childUserChangeJson
                + strDetalle_Aseguramiento_de_Drogas_InvolucradasScript.Substring(endIndexOfMainElementHistory + indexOfArrayHistory, strDetalle_Aseguramiento_de_Drogas_InvolucradasScript.Length - (endIndexOfMainElementHistory + indexOfArrayHistory));
			}
            
            

            using (StreamWriter w = new StreamWriter(Server.MapPath("~/Uploads/Scripts/Detalle_Aseguramiento_de_Drogas_Involucradas.js")))
            {
        ...
        public JsonResult ReadScriptSettings()
        {
            ...
            if (System.IO.File.Exists(Server.MapPath("~/Uploads/Scripts/Detalle_Aseguramiento_de_Drogas_Involucradas.js")))
            {
                using (StreamReader r = new StreamReader(Server.MapPath("~/Uploads/Scripts/Detalle_Aseguramiento_de_Drogas_Involucradas.js")))
                {
        ...
        [HttpGet]
        public ActionResult Detalle_Aseguramiento_de_Drogas_InvolucradasPropertyBag()
        {
            return PartialView("Detalle_Aseguramiento_de_Drogas_InvolucradasPropertyBag", "Detalle_Aseguramiento_de_Drogas_Involucradas");
        }
        ...
        public void Export(string format, int pageIndex, int pageSize)
        {
            ...
            switch (exportFormatType)
            {
                case ExportFormatType.PDF:
                    PdfConverter.ExportToPdf(data.ToDataTable(), "Detalle_Aseguramiento_de_Drogas_InvolucradasList_" + DateTime.Now.ToString());
                    break;

                case ExportFormatType.EXCEL:
                    ExcelConverter.ExportToExcel(data.ToDataTable(), "Detalle_Aseguramiento_de_Drogas_InvolucradasList_" + DateTime.Now.ToString());
                    break;
