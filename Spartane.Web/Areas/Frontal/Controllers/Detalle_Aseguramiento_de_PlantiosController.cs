...
namespace Spartane.Web.Areas.Frontal.Controllers
{
    ...
    public class Detalle_Aseguramiento_de_PlantiosController : Controller
    {
        ...
        // GET: Frontal/Detalle_Aseguramiento_de_Plantios
        [ObjectAuth(ObjectId = (ModuleObjectId)45537, PermissionType = PermissionTypes.Consult)]
        ...
        // GET: Frontal/Detalle_Aseguramiento_de_Plantios/Create
        [ObjectAuth(ObjectId = (ModuleObjectId)45537, PermissionType = PermissionTypes.New,
	...
	[HttpGet]
        ...
        public ActionResult GetTipo_de_PlantioAll()
        {
            try
            {
                ...
                return Json(result.OrderBy(m => m.Descripcion).Select(m => new SelectListItem
                {
                     Text = CultureHelper.GetTraduction(Convert.ToString(m.Clave), "Tipo_de_Plantio", "Descripcion")?? m.Descripcion,
                    Value = Convert.ToString(m.Clave)
                }).ToArray(), JsonRequestBehavior.AllowGet);
            }
            catch (ServiceException ex)
        ...
        public ActionResult GetMetodo_de_DestruccionAll()
        {
            try
            {
                ...
                return Json(result.OrderBy(m => m.Descripcion).Select(m => new SelectListItem
                {
                     Text = CultureHelper.GetTraduction(Convert.ToString(m.Clave), "Metodo_de_Destruccion", "Descripcion")?? m.Descripcion,
                    Value = Convert.ToString(m.Clave)
                }).ToArray(), JsonRequestBehavior.AllowGet);
            }
            catch (ServiceException ex)
        ...
        public ActionResult Delete(int id)
        {
            try
            {
                ...
                Detalle_Aseguramiento_de_Plantios varDetalle_Aseguramiento_de_Plantios = null;
                if (id.ToString() != "0")
                {
                        string where = "";

                }
                var result = _IDetalle_Aseguramiento_de_PlantiosApiConsumer.Delete(id, null, null).Resource;
        ...
        /// <summary>
        /// Write Element Array of Detalle_Aseguramiento_de_Plantios script
        /// </summary>
        /// <param name="oDetalle_Aseguramiento_de_PlantiosElements"></param>
        /// <returns></returns>
        [HttpPost]
        public JsonResult WriteScriptSettings(CustomElements Detalle_Aseguramiento_de_PlantiosModuleAttributeList)
        {
            for (int i = 0; i < Detalle_Aseguramiento_de_PlantiosModuleAttributeList.CustomModuleAttributeList.Count - 1; i++)
            {
                if (string.IsNullOrEmpty(Detalle_Aseguramiento_de_PlantiosModuleAttributeList.CustomModuleAttributeList[i].DefaultValue))
                {
                    Detalle_Aseguramiento_de_PlantiosModuleAttributeList.CustomModuleAttributeList[i].DefaultValue = string.Empty;
                }
                if (string.IsNullOrEmpty(Detalle_Aseguramiento_de_PlantiosModuleAttributeList.CustomModuleAttributeList[i].HelpText))
                {
                    Detalle_Aseguramiento_de_PlantiosModuleAttributeList.CustomModuleAttributeList[i].HelpText = string.Empty;
                }
            }
			if (Detalle_Aseguramiento_de_PlantiosModuleAttributeList.ChildModuleAttributeList != null)
            {
				for (int i = 0; i < Detalle_Aseguramiento_de_PlantiosModuleAttributeList.ChildModuleAttributeList.Count - 1; i++)
				{
					if (string.IsNullOrEmpty(Detalle_Aseguramiento_de_PlantiosModuleAttributeList.ChildModuleAttributeList[i].DefaultValue))
					{
						Detalle_Aseguramiento_de_PlantiosModuleAttributeList.ChildModuleAttributeList[i].DefaultValue = string.Empty;
					}
					if (string.IsNullOrEmpty(Detalle_Aseguramiento_de_PlantiosModuleAttributeList.ChildModuleAttributeList[i].HelpText))
					{
						Detalle_Aseguramiento_de_PlantiosModuleAttributeList.ChildModuleAttributeList[i].HelpText = string.Empty;
					}
				}
			}
            string strDetalle_Aseguramiento_de_PlantiosScript = string.Empty;
            using (StreamReader r = new StreamReader(Server.MapPath("~/Uploads/Scripts/Detalle_Aseguramiento_de_Plantios.js")))
            {
                strDetalle_Aseguramiento_de_PlantiosScript = r.ReadToEnd();
            }

            JavaScriptSerializer jsSerialize = new JavaScriptSerializer();

            // get json string of change Detalle_Aseguramiento_de_Plantios element attributes
            string userChangeJson = jsSerialize.Serialize(Detalle_Aseguramiento_de_PlantiosModuleAttributeList.CustomModuleAttributeList);

            int indexOfArray = strDetalle_Aseguramiento_de_PlantiosScript.IndexOf("inpuElementArray");
            string splittedString = strDetalle_Aseguramiento_de_PlantiosScript.Substring(indexOfArray, strDetalle_Aseguramiento_de_PlantiosScript.Length - indexOfArray);
            int indexOfMainElement = splittedString.IndexOf('[');
            int endIndexOfMainElement = splittedString.IndexOf(']') + 1;

            // get json string of change job history element attributes
            string childUserChangeJson = jsSerialize.Serialize(Detalle_Aseguramiento_de_PlantiosModuleAttributeList.ChildModuleAttributeList);
			...
			if (Detalle_Aseguramiento_de_PlantiosModuleAttributeList.ChildModuleAttributeList != null)
            {
				indexOfArrayHistory = strDetalle_Aseguramiento_de_PlantiosScript.IndexOf("inpuElementChildArray");
				splittedStringHistory = strDetalle_Aseguramiento_de_PlantiosScript.Substring(indexOfArrayHistory, strDetalle_Aseguramiento_de_PlantiosScript.Length - indexOfArrayHistory);
				indexOfMainElementHistory = splittedStringHistory.IndexOf('[');
				endIndexOfMainElementHistory = splittedStringHistory.IndexOf(']') + 1;
			}
			string finalResponse = strDetalle_Aseguramiento_de_PlantiosScript.Substring(0, indexOfArray + indexOfMainElement) + userChangeJson + strDetalle_Aseguramiento_de_PlantiosScript.Substring(endIndexOfMainElement + indexOfArray, strDetalle_Aseguramiento_de_PlantiosScript.Length - (endIndexOfMainElement + indexOfArray));
            if (Detalle_Aseguramiento_de_PlantiosModuleAttributeList.ChildModuleAttributeList != null)
            {
				finalResponse = strDetalle_Aseguramiento_de_PlantiosScript.Substring(0, indexOfArray + indexOfMainElement) + userChangeJson
                + strDetalle_Aseguramiento_de_PlantiosScript.Substring(endIndexOfMainElement + indexOfArray, (indexOfMainElementHistory + indexOfArrayHistory) - (endIndexOfMainElement + indexOfArray)) + childUserChangeJson
                + strDetalle_Aseguramiento_de_PlantiosScript.Substring(endIndexOfMainElementHistory + indexOfArrayHistory, strDetalle_Aseguramiento_de_PlantiosScript.Length - (endIndexOfMainElementHistory + indexOfArrayHistory));
			}
            
            

            using (StreamWriter w = new StreamWriter(Server.MapPath("~/Uploads/Scripts/Detalle_Aseguramiento_de_Plantios.js")))
            {
        ...
        public JsonResult ReadScriptSettings()
        {
            ...
            if (System.IO.File.Exists(Server.MapPath("~/Uploads/Scripts/Detalle_Aseguramiento_de_Plantios.js")))
            {
                using (StreamReader r = new StreamReader(Server.MapPath("~/Uploads/Scripts/Detalle_Aseguramiento_de_Plantios.js")))
                {
        ...
        [HttpGet]
        public ActionResult Detalle_Aseguramiento_de_PlantiosPropertyBag()
        {
            return PartialView("Detalle_Aseguramiento_de_PlantiosPropertyBag", "Detalle_Aseguramiento_de_Plantios");
        }
        ...
        public void Export(string format, int pageIndex, int pageSize)
        {
            ...
            switch (exportFormatType)
            {
                case ExportFormatType.PDF:
                    PdfConverter.ExportToPdf(data.ToDataTable(), "Detalle_Aseguramiento_de_PlantiosList_" + DateTime.Now.ToString());
                    break;

                case ExportFormatType.EXCEL:
                    ExcelConverter.ExportToExcel(data.ToDataTable(), "Detalle_Aseguramiento_de_PlantiosList_" + DateTime.Now.ToString());
                    break;
