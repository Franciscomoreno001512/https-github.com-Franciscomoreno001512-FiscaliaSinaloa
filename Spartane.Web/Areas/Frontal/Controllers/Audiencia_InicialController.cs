            ...
            var jsonResult = Json(new
            {
                data = result.Detalle_Relaciones_Audiencia_Inicials.Select(m => new Detalle_Relaciones_Audiencia_InicialGridModel
                {
                    Clave = m.Clave
                        ...
                        ,Imputado = m.Imputado
                        ,ImputadoNombre_Completo_del_Tutor = CultureHelper.GetTraduction(m.Imputado_Detalle_de_Imputado.Clave.ToString(), "Nombre_Completo_del_Tutor") ??(string)m.Imputado_Detalle_de_Imputado.Nombre_Completo_del_Tutor
                        ,Delito = m.Delito
