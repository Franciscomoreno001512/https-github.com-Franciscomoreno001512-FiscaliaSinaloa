...
namespace Spartane.Web.Areas.Frontal.Controllers
{
    ...
    public class Detalle_de_Persona_Moral_MPIController : Controller
    {
        #region "variable declaration"

        private IDetalle_de_Persona_Moral_MPIService service = null;
        ...
        // GET: Frontal/Detalle_de_Persona_Moral_MPI
        [ObjectAuth(ObjectId = (ModuleObjectId)45121, PermissionType = PermissionTypes.Consult)]
        ...
        // GET: Frontal/Detalle_de_Persona_Moral_MPI/Create
        [ObjectAuth(ObjectId = (ModuleObjectId)45121, PermissionType = PermissionTypes.New,
	...
	[HttpGet]
        ...
        public ActionResult Delete(int id)
        {
            try
            {
                ...
                Detalle_de_Persona_Moral_MPI varDetalle_de_Persona_Moral_MPI = null;
                if (id.ToString() != "0")
                {
                        string where = "";

                }
                var result = _IDetalle_de_Persona_Moral_MPIApiConsumer.Delete(id, null, null).Resource;
        ...
        [HttpPost]
        public ActionResult Post(bool IsNew, Detalle_de_Persona_Moral_MPIModel varDetalle_de_Persona_Moral_MPI)
        {
            try
            {
				if (ModelState.IsValid)
				{
                    ...
                    var result = "";
                    var Detalle_de_Persona_Moral_MPIInfo = new Detalle_de_Persona_Moral_MPI
                    {
                        Clave = varDetalle_de_Persona_Moral_MPI.Clave
                        ,Nombre = varDetalle_de_Persona_Moral_MPI.Nombre
                        ,Apellido_Paterno = varDetalle_de_Persona_Moral_MPI.Apellido_Paterno
                        ,Apellido_Materno = varDetalle_de_Persona_Moral_MPI.Apellido_Materno
                        ,Nombre_Completo = varDetalle_de_Persona_Moral_MPI.Nombre_Completo
                        ,Calidad_Juridica = varDetalle_de_Persona_Moral_MPI.Calidad_Juridica
                        ,Razon_Social = varDetalle_de_Persona_Moral_MPI.Razon_Social
                        ,Pais = varDetalle_de_Persona_Moral_MPI.Pais
                        ,Estado = varDetalle_de_Persona_Moral_MPI.Estado
                        ,Municipio = varDetalle_de_Persona_Moral_MPI.Municipio
                        ,Localidad = varDetalle_de_Persona_Moral_MPI.Localidad
                        ,Colonia = varDetalle_de_Persona_Moral_MPI.Colonia
                        ,Calle = varDetalle_de_Persona_Moral_MPI.Calle
                        ,Numero_Exterior = varDetalle_de_Persona_Moral_MPI.Numero_Exterior
                        ,Numero_Interior = varDetalle_de_Persona_Moral_MPI.Numero_Interior
                        ,Telefono = varDetalle_de_Persona_Moral_MPI.Telefono
                        ,Extension = varDetalle_de_Persona_Moral_MPI.Extension
                        ,Celular = varDetalle_de_Persona_Moral_MPI.Celular
                        ,Correo_Electronico = varDetalle_de_Persona_Moral_MPI.Correo_Electronico

                    };

                    result = !IsNew ?
                        _IDetalle_de_Persona_Moral_MPIApiConsumer.Update(Detalle_de_Persona_Moral_MPIInfo, null, null).Resource.ToString() :
                         _IDetalle_de_Persona_Moral_MPIApiConsumer.Insert(Detalle_de_Persona_Moral_MPIInfo, null, null).Resource.ToString();
        ...
        /// <summary>
        /// Write Element Array of Detalle_de_Persona_Moral_MPI script
        /// </summary>
        /// <param name="oDetalle_de_Persona_Moral_MPIElements"></param>
        /// <returns></returns>
        [HttpPost]
        public JsonResult WriteScriptSettings(CustomElements Detalle_de_Persona_Moral_MPIModuleAttributeList)
        {
            for (int i = 0; i < Detalle_de_Persona_Moral_MPIModuleAttributeList.CustomModuleAttributeList.Count - 1; i++)
            {
                if (string.IsNullOrEmpty(Detalle_de_Persona_Moral_MPIModuleAttributeList.CustomModuleAttributeList[i].DefaultValue))
                {
                    Detalle_de_Persona_Moral_MPIModuleAttributeList.CustomModuleAttributeList[i].DefaultValue = string.Empty;
                }
                if (string.IsNullOrEmpty(Detalle_de_Persona_Moral_MPIModuleAttributeList.CustomModuleAttributeList[i].HelpText))
                {
                    Detalle_de_Persona_Moral_MPIModuleAttributeList.CustomModuleAttributeList[i].HelpText = string.Empty;
                }
            }
			if (Detalle_de_Persona_Moral_MPIModuleAttributeList.ChildModuleAttributeList != null)
            {
				for (int i = 0; i < Detalle_de_Persona_Moral_MPIModuleAttributeList.ChildModuleAttributeList.Count - 1; i++)
				{
					if (string.IsNullOrEmpty(Detalle_de_Persona_Moral_MPIModuleAttributeList.ChildModuleAttributeList[i].DefaultValue))
					{
						Detalle_de_Persona_Moral_MPIModuleAttributeList.ChildModuleAttributeList[i].DefaultValue = string.Empty;
					}
					if (string.IsNullOrEmpty(Detalle_de_Persona_Moral_MPIModuleAttributeList.ChildModuleAttributeList[i].HelpText))
					{
						Detalle_de_Persona_Moral_MPIModuleAttributeList.ChildModuleAttributeList[i].HelpText = string.Empty;
					}
				}
			}
            string strDetalle_de_Persona_Moral_MPIScript = string.Empty;
            using (StreamReader r = new StreamReader(Server.MapPath("~/Uploads/Scripts/Detalle_de_Persona_Moral_MPI.js")))
            {
                strDetalle_de_Persona_Moral_MPIScript = r.ReadToEnd();
            }

            JavaScriptSerializer jsSerialize = new JavaScriptSerializer();

            // get json string of change Detalle_de_Persona_Moral_MPI element attributes
            string userChangeJson = jsSerialize.Serialize(Detalle_de_Persona_Moral_MPIModuleAttributeList.CustomModuleAttributeList);

            int indexOfArray = strDetalle_de_Persona_Moral_MPIScript.IndexOf("inpuElementArray");
            string splittedString = strDetalle_de_Persona_Moral_MPIScript.Substring(indexOfArray, strDetalle_de_Persona_Moral_MPIScript.Length - indexOfArray);
            int indexOfMainElement = splittedString.IndexOf('[');
            int endIndexOfMainElement = splittedString.IndexOf(']') + 1;

            // get json string of change job history element attributes
            string childUserChangeJson = jsSerialize.Serialize(Detalle_de_Persona_Moral_MPIModuleAttributeList.ChildModuleAttributeList);
			...
			if (Detalle_de_Persona_Moral_MPIModuleAttributeList.ChildModuleAttributeList != null)
            {
				indexOfArrayHistory = strDetalle_de_Persona_Moral_MPIScript.IndexOf("inpuElementChildArray");
				splittedStringHistory = strDetalle_de_Persona_Moral_MPIScript.Substring(indexOfArrayHistory, strDetalle_de_Persona_Moral_MPIScript.Length - indexOfArrayHistory);
				indexOfMainElementHistory = splittedStringHistory.IndexOf('[');
				endIndexOfMainElementHistory = splittedStringHistory.IndexOf(']') + 1;
			}
			string finalResponse = strDetalle_de_Persona_Moral_MPIScript.Substring(0, indexOfArray + indexOfMainElement) + userChangeJson + strDetalle_de_Persona_Moral_MPIScript.Substring(endIndexOfMainElement + indexOfArray, strDetalle_de_Persona_Moral_MPIScript.Length - (endIndexOfMainElement + indexOfArray));
            if (Detalle_de_Persona_Moral_MPIModuleAttributeList.ChildModuleAttributeList != null)
            {
				finalResponse = strDetalle_de_Persona_Moral_MPIScript.Substring(0, indexOfArray + indexOfMainElement) + userChangeJson
                + strDetalle_de_Persona_Moral_MPIScript.Substring(endIndexOfMainElement + indexOfArray, (indexOfMainElementHistory + indexOfArrayHistory) - (endIndexOfMainElement + indexOfArray)) + childUserChangeJson
                + strDetalle_de_Persona_Moral_MPIScript.Substring(endIndexOfMainElementHistory + indexOfArrayHistory, strDetalle_de_Persona_Moral_MPIScript.Length - (endIndexOfMainElementHistory + indexOfArrayHistory));
			}
            
            

            using (StreamWriter w = new StreamWriter(Server.MapPath("~/Uploads/Scripts/Detalle_de_Persona_Moral_MPI.js")))
            {
        ...
        public JsonResult ReadScriptSettings()
        {
            ...
            if (System.IO.File.Exists(Server.MapPath("~/Uploads/Scripts/Detalle_de_Persona_Moral_MPI.js")))
            {
                using (StreamReader r = new StreamReader(Server.MapPath("~/Uploads/Scripts/Detalle_de_Persona_Moral_MPI.js")))
                {
        ...
        [HttpGet]
        public ActionResult Detalle_de_Persona_Moral_MPIPropertyBag()
        {
            return PartialView("Detalle_de_Persona_Moral_MPIPropertyBag", "Detalle_de_Persona_Moral_MPI");
        }
