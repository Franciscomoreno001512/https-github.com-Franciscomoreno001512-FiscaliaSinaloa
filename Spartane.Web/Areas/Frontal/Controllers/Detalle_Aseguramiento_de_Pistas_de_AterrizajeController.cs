        ...
        public ActionResult Create(int Id = 0,  int consult = 0)
        {
            ...
            if ((Id.GetType() == typeof(string) && Id.ToString() != "") || ((Id.GetType() == typeof(int) || Id.GetType() == typeof(Int16) || Id.GetType() == typeof(Int32) || Id.GetType() == typeof(Int64) || Id.GetType() == typeof(short))&& Id.ToString() != "0"))
            {
                ...
                varDetalle_Aseguramiento_de_Pistas_de_Aterrizaje = new Detalle_Aseguramiento_de_Pistas_de_AterrizajeModel
                {
                    ...
                    ,Motivo_de_Registro = Detalle_Aseguramiento_de_Pistas_de_AterrizajeData.Motivo_de_Registro
                    ,Motivo_de_RegistroDescripcion = CultureHelper.GetTraduction(Convert.ToString(Detalle_Aseguramiento_de_Pistas_de_AterrizajeData.Motivo_de_Registro), "Motivo_de_Registro") ??  (string)Detalle_Aseguramiento_de_Pistas_de_AterrizajeData.Motivo_de_Registro_Motivo_de_Registro.Descripcion
            ...
            try
            {
				if (ModelState.IsValid)
				{
                    ...
                    var Detalle_Aseguramiento_de_Pistas_de_AterrizajeInfo = new Detalle_Aseguramiento_de_Pistas_de_Aterrizaje
                    {
                        ...
                        ,Motivo_de_Registro = varDetalle_Aseguramiento_de_Pistas_de_Aterrizaje.Motivo_de_Registro
