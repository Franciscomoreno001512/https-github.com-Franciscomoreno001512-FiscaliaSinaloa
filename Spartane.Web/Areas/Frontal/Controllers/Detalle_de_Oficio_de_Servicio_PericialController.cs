...
namespace Spartane.Web.Areas.Frontal.Controllers
{
    ...
    public class Detalle_de_Oficio_de_Servicio_PericialController : Controller
    {
        #region "variable declaration"

        private IDetalle_de_Oficio_de_Servicio_PericialService service = null;
        ...
        public Detalle_de_Oficio_de_Servicio_PericialController(IDetalle_de_Oficio_de_Servicio_PericialService service,ITokenManager tokenManager, IAuthenticationApiConsumer authenticationApiConsumer, IDetalle_de_Oficio_de_Servicio_PericialApiConsumer Detalle_de_Oficio_de_Servicio_PericialApiConsumer, ISpartane_FileApiConsumer Spartane_FileApiConsumer, ISpartan_Business_RuleApiConsumer Spartan_Business_RuleApiConsumer, ISpartan_BR_Process_Event_DetailApiConsumer Spartan_BR_Process_Event_DetailApiConsumer , ITipo_de_OficiosApiConsumer Tipo_de_OficiosApiConsumer , IServicios_PericialesApiConsumer Servicios_PericialesApiConsumer )
        {
        ...
        // GET: Frontal/Detalle_de_Oficio_de_Servicio_Pericial
        [ObjectAuth(ObjectId = (ModuleObjectId)45160, PermissionType = PermissionTypes.Consult)]
        ...
        // GET: Frontal/Detalle_de_Oficio_de_Servicio_Pericial/Create
        [ObjectAuth(ObjectId = (ModuleObjectId)45160, PermissionType = PermissionTypes.New,
	...
	[HttpGet]
        ...
        public ActionResult GetTipo_de_OficiosAll()
        {
            try
            {
                ...
                {
                     Text = CultureHelper.GetTraduction(Convert.ToString(m.Clave), "Tipo_de_Oficios", "Descripcion")?? m.Descripcion,
        ...
        public ActionResult Get()
        {
            ...
            if (filter != null)
                configuration = GridQueryHelper.GetConfiguration(filter, new Detalle_de_Oficio_de_Servicio_PericialPropertyMapper());

            var pageSize = Convert.ToInt32(filter["pageSize"]);
            var pageIndex = Convert.ToInt32(filter["pageIndex"]);
            var result = _IDetalle_de_Oficio_de_Servicio_PericialApiConsumer.ListaSelAll((pageIndex * pageSize) - pageSize + 1, pageSize, configuration.WhereClause, configuration.OrderByClause ?? "").Resource;
        ...
        public ActionResult Delete(int id)
        {
            try
            {
                ...
                Detalle_de_Oficio_de_Servicio_Pericial varDetalle_de_Oficio_de_Servicio_Pericial = null;
                if (id.ToString() != "0")
                {
                        string where = "";

                }
                var result = _IDetalle_de_Oficio_de_Servicio_PericialApiConsumer.Delete(id, null, null).Resource;
        ...
        /// <summary>
        /// Write Element Array of Detalle_de_Oficio_de_Servicio_Pericial script
        /// </summary>
        /// <param name="oDetalle_de_Oficio_de_Servicio_PericialElements"></param>
        /// <returns></returns>
        [HttpPost]
        public JsonResult WriteScriptSettings(CustomElements Detalle_de_Oficio_de_Servicio_PericialModuleAttributeList)
        {
            for (int i = 0; i < Detalle_de_Oficio_de_Servicio_PericialModuleAttributeList.CustomModuleAttributeList.Count - 1; i++)
            {
                if (string.IsNullOrEmpty(Detalle_de_Oficio_de_Servicio_PericialModuleAttributeList.CustomModuleAttributeList[i].DefaultValue))
                {
                    Detalle_de_Oficio_de_Servicio_PericialModuleAttributeList.CustomModuleAttributeList[i].DefaultValue = string.Empty;
                }
                if (string.IsNullOrEmpty(Detalle_de_Oficio_de_Servicio_PericialModuleAttributeList.CustomModuleAttributeList[i].HelpText))
                {
                    Detalle_de_Oficio_de_Servicio_PericialModuleAttributeList.CustomModuleAttributeList[i].HelpText = string.Empty;
                }
            }
			if (Detalle_de_Oficio_de_Servicio_PericialModuleAttributeList.ChildModuleAttributeList != null)
            {
				for (int i = 0; i < Detalle_de_Oficio_de_Servicio_PericialModuleAttributeList.ChildModuleAttributeList.Count - 1; i++)
				{
					if (string.IsNullOrEmpty(Detalle_de_Oficio_de_Servicio_PericialModuleAttributeList.ChildModuleAttributeList[i].DefaultValue))
					{
						Detalle_de_Oficio_de_Servicio_PericialModuleAttributeList.ChildModuleAttributeList[i].DefaultValue = string.Empty;
					}
					if (string.IsNullOrEmpty(Detalle_de_Oficio_de_Servicio_PericialModuleAttributeList.ChildModuleAttributeList[i].HelpText))
					{
						Detalle_de_Oficio_de_Servicio_PericialModuleAttributeList.ChildModuleAttributeList[i].HelpText = string.Empty;
					}
				}
			}
            string strDetalle_de_Oficio_de_Servicio_PericialScript = string.Empty;
            using (StreamReader r = new StreamReader(Server.MapPath("~/Uploads/Scripts/Detalle_de_Oficio_de_Servicio_Pericial.js")))
            {
                strDetalle_de_Oficio_de_Servicio_PericialScript = r.ReadToEnd();
            }

            JavaScriptSerializer jsSerialize = new JavaScriptSerializer();

            // get json string of change Detalle_de_Oficio_de_Servicio_Pericial element attributes
            string userChangeJson = jsSerialize.Serialize(Detalle_de_Oficio_de_Servicio_PericialModuleAttributeList.CustomModuleAttributeList);

            int indexOfArray = strDetalle_de_Oficio_de_Servicio_PericialScript.IndexOf("inpuElementArray");
            string splittedString = strDetalle_de_Oficio_de_Servicio_PericialScript.Substring(indexOfArray, strDetalle_de_Oficio_de_Servicio_PericialScript.Length - indexOfArray);
            int indexOfMainElement = splittedString.IndexOf('[');
            int endIndexOfMainElement = splittedString.IndexOf(']') + 1;

            // get json string of change job history element attributes
            string childUserChangeJson = jsSerialize.Serialize(Detalle_de_Oficio_de_Servicio_PericialModuleAttributeList.ChildModuleAttributeList);
			...
			if (Detalle_de_Oficio_de_Servicio_PericialModuleAttributeList.ChildModuleAttributeList != null)
            {
				indexOfArrayHistory = strDetalle_de_Oficio_de_Servicio_PericialScript.IndexOf("inpuElementChildArray");
				splittedStringHistory = strDetalle_de_Oficio_de_Servicio_PericialScript.Substring(indexOfArrayHistory, strDetalle_de_Oficio_de_Servicio_PericialScript.Length - indexOfArrayHistory);
				indexOfMainElementHistory = splittedStringHistory.IndexOf('[');
				endIndexOfMainElementHistory = splittedStringHistory.IndexOf(']') + 1;
			}
			string finalResponse = strDetalle_de_Oficio_de_Servicio_PericialScript.Substring(0, indexOfArray + indexOfMainElement) + userChangeJson + strDetalle_de_Oficio_de_Servicio_PericialScript.Substring(endIndexOfMainElement + indexOfArray, strDetalle_de_Oficio_de_Servicio_PericialScript.Length - (endIndexOfMainElement + indexOfArray));
            if (Detalle_de_Oficio_de_Servicio_PericialModuleAttributeList.ChildModuleAttributeList != null)
            {
				finalResponse = strDetalle_de_Oficio_de_Servicio_PericialScript.Substring(0, indexOfArray + indexOfMainElement) + userChangeJson
                + strDetalle_de_Oficio_de_Servicio_PericialScript.Substring(endIndexOfMainElement + indexOfArray, (indexOfMainElementHistory + indexOfArrayHistory) - (endIndexOfMainElement + indexOfArray)) + childUserChangeJson
                + strDetalle_de_Oficio_de_Servicio_PericialScript.Substring(endIndexOfMainElementHistory + indexOfArrayHistory, strDetalle_de_Oficio_de_Servicio_PericialScript.Length - (endIndexOfMainElementHistory + indexOfArrayHistory));
			}
            
            

            using (StreamWriter w = new StreamWriter(Server.MapPath("~/Uploads/Scripts/Detalle_de_Oficio_de_Servicio_Pericial.js")))
            {
        ...
        public JsonResult ReadScriptSettings()
        {
            ...
            if (System.IO.File.Exists(Server.MapPath("~/Uploads/Scripts/Detalle_de_Oficio_de_Servicio_Pericial.js")))
            {
                using (StreamReader r = new StreamReader(Server.MapPath("~/Uploads/Scripts/Detalle_de_Oficio_de_Servicio_Pericial.js")))
                {
        ...
        [HttpGet]
        public ActionResult Detalle_de_Oficio_de_Servicio_PericialPropertyBag()
        {
            return PartialView("Detalle_de_Oficio_de_Servicio_PericialPropertyBag", "Detalle_de_Oficio_de_Servicio_Pericial");
        }
        ...
        public void Export(string format, int pageIndex, int pageSize)
        {
            ...
            var data = result.Detalle_de_Oficio_de_Servicio_Pericials.Select(m => new Detalle_de_Oficio_de_Servicio_PericialGridModel
            {
                Clave = m.Clave
                ,OficioDescripcion = (string)m.Oficio_Tipo_de_Oficios.Descripcion
                ,Servicio_PericialServicio = (string)m.Servicio_Pericial_Servicios_Periciales.Servicio
            ...
            switch (exportFormatType)
            {
                case ExportFormatType.PDF:
                    PdfConverter.ExportToPdf(data.ToDataTable(), "Detalle_de_Oficio_de_Servicio_PericialList_" + DateTime.Now.ToString());
                    break;

                case ExportFormatType.EXCEL:
                    ExcelConverter.ExportToExcel(data.ToDataTable(), "Detalle_de_Oficio_de_Servicio_PericialList_" + DateTime.Now.ToString());
                    break;
