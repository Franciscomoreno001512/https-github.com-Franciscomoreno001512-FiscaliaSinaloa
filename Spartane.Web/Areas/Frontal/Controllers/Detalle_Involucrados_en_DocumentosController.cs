...
namespace Spartane.Web.Areas.Frontal.Controllers
{
    ...
    public class Detalle_Involucrados_en_DocumentosController : Controller
    {
        ...
        public ActionResult Create(int Id = 0,  int consult = 0)
        {
            ...
            if ((Id.GetType() == typeof(string) && Id.ToString() != "") || ((Id.GetType() == typeof(int) || Id.GetType() == typeof(Int16) || Id.GetType() == typeof(Int32) || Id.GetType() == typeof(Int64) || Id.GetType() == typeof(short))&& Id.ToString() != "0"))
            {
                ...
                var Detalle_Involucrados_en_DocumentosData = _IDetalle_Involucrados_en_DocumentosApiConsumer.GetByKeyComplete(Id).Resource.Detalle_Involucrados_en_Documentoss[0];
                if (Detalle_Involucrados_en_DocumentosData == null)
                    return HttpNotFound();

                varDetalle_Involucrados_en_Documentos = new Detalle_Involucrados_en_DocumentosModel
                {
                    Clave = (int)Detalle_Involucrados_en_DocumentosData.Clave
	...
	[HttpGet]
        public ActionResult AddDetalle_Involucrados_en_Documentos(int rowIndex = 0, int functionMode = 0, int id = 0)
        {
            int ModuleId = (Session["CurrentModuleId"] != null) ? Convert.ToInt32(Session["CurrentModuleId"]) : 0;
        ...
        /// <returns></returns>
        [HttpPost]
        public JsonResult WriteScriptSettings(CustomElements Detalle_Involucrados_en_DocumentosModuleAttributeList)
        {
			...
			if (Detalle_Involucrados_en_DocumentosModuleAttributeList.ChildModuleAttributeList != null)
            {
				...
				{
					if (string.IsNullOrEmpty(Detalle_Involucrados_en_DocumentosModuleAttributeList.ChildModuleAttributeList[i].DefaultValue))
					{
						Detalle_Involucrados_en_DocumentosModuleAttributeList.ChildModuleAttributeList[i].DefaultValue = string.Empty;
					}
					if (string.IsNullOrEmpty(Detalle_Involucrados_en_DocumentosModuleAttributeList.ChildModuleAttributeList[i].HelpText))
					{
						Detalle_Involucrados_en_DocumentosModuleAttributeList.ChildModuleAttributeList[i].HelpText = string.Empty;
					}
				}
			}
			...
			if (Detalle_Involucrados_en_DocumentosModuleAttributeList.ChildModuleAttributeList != null)
            {
				indexOfArrayHistory = strDetalle_Involucrados_en_DocumentosScript.IndexOf("inpuElementChildArray");
            ...
            if (Detalle_Involucrados_en_DocumentosModuleAttributeList.ChildModuleAttributeList != null)
            {
				finalResponse = strDetalle_Involucrados_en_DocumentosScript.Substring(0, indexOfArray + indexOfMainElement) + userChangeJson
                + strDetalle_Involucrados_en_DocumentosScript.Substring(endIndexOfMainElement + indexOfArray, (indexOfMainElementHistory + indexOfArrayHistory) - (endIndexOfMainElement + indexOfArray)) + childUserChangeJson
                + strDetalle_Involucrados_en_DocumentosScript.Substring(endIndexOfMainElementHistory + indexOfArrayHistory, strDetalle_Involucrados_en_DocumentosScript.Length - (endIndexOfMainElementHistory + indexOfArrayHistory));
			}
        ...
        public void Export(string format, int pageIndex, int pageSize)
        {
            ...
            {
                Clave = m.Clave
                ,InvolucradoNombre_Completo_del_Tutor = (string)m.Involucrado_Detalle_de_Datos_Generales.Nombre_Completo_del_Tutor
            ...
            switch (exportFormatType)
            {
                case ExportFormatType.PDF:
                    PdfConverter.ExportToPdf(data.ToDataTable(), "Detalle_Involucrados_en_DocumentosList_" + DateTime.Now.ToString());
                    break;

                case ExportFormatType.EXCEL:
                    ExcelConverter.ExportToExcel(data.ToDataTable(), "Detalle_Involucrados_en_DocumentosList_" + DateTime.Now.ToString());
                    break;
