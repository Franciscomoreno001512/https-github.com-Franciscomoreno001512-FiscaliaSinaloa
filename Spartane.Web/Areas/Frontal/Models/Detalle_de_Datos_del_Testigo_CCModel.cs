...
{
    public class Detalle_de_Datos_del_Testigo_CCModel
    {
        [Required]
	...
	public class Detalle_de_Datos_del_Testigo_CC_Datos_GeneralesModel
    {
        [Required]
        public int Clave { get; set; }
        public string Apellido_Materno { get; set; }
	...
	public class Detalle_de_Datos_del_Testigo_CC_GaleriaModel
    {
        [Required]
        public int Clave { get; set; }
