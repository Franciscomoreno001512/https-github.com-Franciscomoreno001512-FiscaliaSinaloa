...
namespace Spartane.Web.Areas.Frontal.Models
{
	...
	public class Solicitud_de_Denuncia_Ciudadana_ResolucionModel
    {
        [Required]
        public int Clave { get; set; }
        public string Motivo { get; set; }
	...
	public class Solicitud_de_Denuncia_Ciudadana_Asignar_Responsable_de_AtencionModel
    {
        [Required]
        public int Clave { get; set; }
        public string Fecha_de_Asignacion { get; set; }
	...
	public class Solicitud_de_Denuncia_Ciudadana_AtencionModel
    {
        [Required]
        public int Clave { get; set; }
        public string Fecha_de_Atencion { get; set; }
