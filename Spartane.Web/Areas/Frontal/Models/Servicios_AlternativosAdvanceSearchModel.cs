...
{
    public class Servicios_AlternativosAdvanceSearchModel
    {
        public Servicios_AlternativosAdvanceSearchModel()
        {
            CJusticia_Alternativa = RadioOptions.NoApply;
        ...
        public RadioOptions CJusticia_Alternativa { set; get; }
