...
{
    public class Detalle_del_Abogado_Victima_MPIModel
    {
        [Required]
        public int Consecutivo_Victima { get; set; }
        public int? Nombre_Completo_del_Abogado_Victima { get; set; }
        public string Nombre_Completo_del_Abogado_VictimaNombre_Completo { get; set; }
        ...
        public string Sexo_del_Abogado_VictimaDescripcion { get; set; }
        public int? Estado_Civil_del_Abogado_Victima { get; set; }
        public string Estado_Civil_del_Abogado_VictimaDescripcion { get; set; }
        public int? Tipo_de_Identificacion_Abogado_Victima { get; set; }
        public string Tipo_de_Identificacion_Abogado_VictimaNombre { get; set; }
        public string Numero_de_Identificacion_Abogado_Victima { get; set; }
        public int? Nacionalidad_del_Abogado_Victima { get; set; }
        public string Nacionalidad_del_Abogado_VictimaNacionalidadC { get; set; }
        public string Cedula_Profesional_del_Abogado_Victima { get; set; }
        public int? Pais_del_Abogado_Victima { get; set; }
        public string Pais_del_Abogado_VictimaNombre { get; set; }
        public int? Estado_del_Abogado_Victima { get; set; }
        public string Estado_del_Abogado_VictimaNombre { get; set; }
        public int? Municipio_del_Abogado_Victima { get; set; }
        public string Municipio_del_Abogado_VictimaNombre { get; set; }
        public int? Colonia_del_Abogado_Victima { get; set; }
        public string Colonia_del_Abogado_VictimaNombre { get; set; }
        [Range(0, 9999999999)]
	...
	public class Detalle_del_Abogado_Victima_MPI_Datos_GeneralesModel
    {
        [Required]
        public int Consecutivo_Victima { get; set; }
        public int? Nombre_Completo_del_Abogado_Victima { get; set; }
