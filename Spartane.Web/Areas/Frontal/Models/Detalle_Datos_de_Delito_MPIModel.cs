...
{
    public class Detalle_Datos_de_Delito_MPIModel
    {
        [Required]
	...
	public class Detalle_Datos_de_Delito_MPI_Datos_GeneralesModel
    {
        [Required]
        public int Clave { get; set; }
        public int? Tipo_de_Delito { get; set; }
	...
	public class Detalle_Datos_de_Delito_MPI_Datos_de_Robo_de_VehiculoModel
    {
        [Required]
        public int Clave { get; set; }
        public short? Circunstancia_de_Vehiculo { get; set; }
	...
	public class Detalle_Datos_de_Delito_MPI_Datos_del_Levantamiento_del_Cadaver_Model
    {
        [Required]
        public int Clave { get; set; }
        public string Causa_de_Muerte { get; set; }
