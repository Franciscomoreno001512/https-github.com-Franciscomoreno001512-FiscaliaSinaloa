...
function getDropdown(elementKey) {
    var labelSelect = $("#Queja_Sugerencia_Ciudadana_cmbLabelSelect").val();
...
function ClearControls() {
    ...
    $('#CreateQueja_Sugerencia_Ciudadana')[0].reset();
    ClearFormControls();
    $("#FolioId").val("0");
...
function ClearFormControls() {
    $('#CreateQueja_Sugerencia_Ciudadana').trigger('reset');
    $('#CreateQueja_Sugerencia_Ciudadana').find(':input').each(function () {
        switch (this.type) {
            case 'password':
            case 'number':
...
function CheckValidation() {
    var $myForm = $('#CreateQueja_Sugerencia_Ciudadana');
...
$(document).ready(function () {
    $("form#CreateQueja_Sugerencia_Ciudadana").submit(function (e) {
        e.preventDefault();
        return false;
    });
...
var Queja_Sugerencia_CiudadanaisdisplayBusinessPropery = false;
Queja_Sugerencia_CiudadanaDisplayBusinessRuleButtons(Queja_Sugerencia_CiudadanaisdisplayBusinessPropery);
function Queja_Sugerencia_CiudadanaDisplayBusinessRule() {
    if (!Queja_Sugerencia_CiudadanaisdisplayBusinessPropery) {
        $('#CreateQueja_Sugerencia_Ciudadana').find('.col-sm-8').each(function () {
            ...
            mainElementAttributes += '<div class="Queja_Sugerencia_CiudadanadisplayBusinessPropery"><button onclick="Queja_Sugerencia_CiudadanaGetBusinessRule()" type="button" data-field-id="' + fieldId + '" data-field-name="' + fieldName + '" data-attribute="' + attribute + '" class="btn btn-info btn-lg btnPopupBusinessRules" data-toggle="modal" data-target="#Queja_Sugerencia_CiudadanaBusinessRule-form"><i class="fa fa-cogs fa-spin"></i></button></div>';
            mainElementAttributes += '</div>';
            $(this).after(mainElementAttributes);
        });
    } else {
        $('.Queja_Sugerencia_CiudadanadisplayBusinessPropery').remove();
    }
    Queja_Sugerencia_CiudadanaDisplayBusinessRuleButtons(!Queja_Sugerencia_CiudadanaisdisplayBusinessPropery);
    Queja_Sugerencia_CiudadanaisdisplayBusinessPropery = (Queja_Sugerencia_CiudadanaisdisplayBusinessPropery ? false : true);
}
function Queja_Sugerencia_CiudadanaDisplayBusinessRuleButtons(flag) {
