...
function getDropdown(elementKey) {
    var labelSelect = $("#Quejas_de_MP_cmbLabelSelect").val();
...
function ClearFormControls() {
    $('#CreateQuejas_de_MP').trigger('reset');
    $('#CreateQuejas_de_MP').find(':input').each(function () {
        switch (this.type) {
            case 'password':
            case 'number':
...
$(document).ready(function () {
    $("form#CreateQuejas_de_MP").submit(function (e) {
        e.preventDefault();
        return false;
    });
...
var Quejas_de_MPisdisplayBusinessPropery = false;
Quejas_de_MPDisplayBusinessRuleButtons(Quejas_de_MPisdisplayBusinessPropery);
function Quejas_de_MPDisplayBusinessRule() {
    if (!Quejas_de_MPisdisplayBusinessPropery) {
        $('#CreateQuejas_de_MP').find('.col-sm-8').each(function () {
            ...
            mainElementAttributes += '<div class="Quejas_de_MPdisplayBusinessPropery"><button onclick="Quejas_de_MPGetBusinessRule()" type="button" data-field-id="' + fieldId + '" data-field-name="' + fieldName + '" data-attribute="' + attribute + '" class="btn btn-info btn-lg btnPopupBusinessRules" data-toggle="modal" data-target="#Quejas_de_MPBusinessRule-form"><i class="fa fa-cogs fa-spin"></i></button></div>';
            mainElementAttributes += '</div>';
            $(this).after(mainElementAttributes);
        });
    } else {
        $('.Quejas_de_MPdisplayBusinessPropery').remove();
    }
    Quejas_de_MPDisplayBusinessRuleButtons(!Quejas_de_MPisdisplayBusinessPropery);
    Quejas_de_MPisdisplayBusinessPropery = (Quejas_de_MPisdisplayBusinessPropery ? false : true);
}
function Quejas_de_MPDisplayBusinessRuleButtons(flag) {
