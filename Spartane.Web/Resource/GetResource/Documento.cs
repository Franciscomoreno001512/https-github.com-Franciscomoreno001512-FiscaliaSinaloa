...
namespace Resources
{
    public partial class DocumentoResources
    {
        ...
        public static string Area_de_Servicios_de_Apoyo
        {
            ...
            {
                SetPath();
                return resourceProviderDocumento.GetResource("Area_de_Servicios_de_Apoyo", CultureInfo.CurrentUICulture.Name) as String;
            }
        }
        ...
        public static string Tipo_de_Localizacion
        {
            ...
            {
                SetPath();
                return resourceProviderDocumento.GetResource("Tipo_de_Localizacion", CultureInfo.CurrentUICulture.Name) as String;
            }
        }
