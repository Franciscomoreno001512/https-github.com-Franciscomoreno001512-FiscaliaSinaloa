...
namespace Resources
{
    public partial class EstatusResources
    {
        ...
        /// <summary>Tiempo1</summary>
        public static string Tiempo1
        {
            get
            {
                SetPath();
                return resourceProviderEstatus.GetResource("Tiempo1", CultureInfo.CurrentUICulture.Name) as String;
            }
        }

        /// <summary>Tiempo2</summary>
        public static string Tiempo2
        {
            get
            {
                SetPath();
                return resourceProviderEstatus.GetResource("Tiempo2", CultureInfo.CurrentUICulture.Name) as String;
            }
        }
        ...
        public static string Vigencia
        {
            ...
            {
                SetPath();
                return resourceProviderEstatus.GetResource("Vigencia", CultureInfo.CurrentUICulture.Name) as String;
            }
        }
        ...
        public static string Observaciones
        {
            ...
            {
                SetPath();
                return resourceProviderEstatus.GetResource("Observaciones", CultureInfo.CurrentUICulture.Name) as String;
            }
        }
