$(document).ready(function () {
    var inpuElementArray = [
        ...
        ,{ "inputId": "Numero_de_Coincidencias", "inputType": "text", "IsRequired": true, "IsVisible": true, "IsReadOnly": false, "DefaultValue": "", "HelpText": "" }

    ];
    setInputEntityAttributes(inpuElementArray, "#", 1);
});

function setDetalle_de_CoincidenciasValidation() {
