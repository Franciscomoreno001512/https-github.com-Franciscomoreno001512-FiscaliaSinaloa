...
+"  set Estatus=2"
+"  where Folio=FLDD[lblFolio]", rowIndex, nameOfTable); SendEmailQuery('SAPROJ - Solicitud de Invitación Atendida', select Email from Spartan_User where Id_User=FLD[Usuario_que_Solicita], "Por este medio se le informa que la invitación no. <b>FLD[Numero_de_Invitacion]</b> del expediente No. <b>FLDD[Expediente_Mecanismos_Alternos]</b> ha sido atendida."
+" "
+" <br><br>"
+" "
