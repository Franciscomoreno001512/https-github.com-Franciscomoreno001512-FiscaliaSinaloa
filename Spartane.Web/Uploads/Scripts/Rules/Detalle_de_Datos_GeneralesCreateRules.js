...
SetRequiredToControl( $('#' + nameOfTable + 'Nombre' + rowIndex));
SetRequiredToControl( $('#' + nameOfTable + 'Apellido_Paterno' + rowIndex));
SetRequiredToControl( $('#' + nameOfTable + 'Fecha_de_Nacimiento' + rowIndex));SetRequiredToControl( $('#' + nameOfTable + 'Ocupacion' + rowIndex)); $('#divNombre').css('display', 'block');$('#divApellido_Paterno').css('display', 'block');$('#divApellido_Materno').css('display', 'block');$('#divSexo').css('display', 'block'); DisabledControl($("#" + nameOfTable + "Nombre" + rowIndex), ("false" == "true"));

if ('false'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Nombre' + rowIndex));}DisabledControl($("#" + nameOfTable + "Apellido_Paterno" + rowIndex), ("false" == "true"));
if ('false'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Apellido_Paterno' + rowIndex));}DisabledControl($("#" + nameOfTable + "Apellido_Materno" + rowIndex), ("false" == "true"));
if ('false'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Apellido_Materno' + rowIndex));} 
 }
if( GetValueByControlType($('#' + nameOfTable + 'Q_Q_R_O_' + rowIndex),nameOfTable,rowIndex)==TryParseInt('false', 'false') && operation == 'Update' ){

    AsignarValor($('#' + nameOfTable + 'Nombre' + rowIndex),EvaluaQuery("SELECT Nombre from Detalle_de_Datos_Generales where clave = FLDD[lblClave] ", rowIndex, nameOfTable));
    AsignarValor($('#' + nameOfTable + 'Apellido_Paterno' + rowIndex),EvaluaQuery("SELECT Apellido_Paterno from Detalle_de_Datos_Generales where clave = FLDD[lblClave]", rowIndex, nameOfTable));
    AsignarValor($('#' + nameOfTable + 'Apellido_Materno' + rowIndex),EvaluaQuery("SELECT Apellido_Materno from Detalle_de_Datos_Generales where clave = FLDD[lblClave]", rowIndex, nameOfTable));
    AsignarValor($('#' + nameOfTable + 'Nombre_Completo' + rowIndex),EvaluaQuery("SELECT Nombre_Completo from Detalle_de_Datos_Generales where clave = FLDD[lblClave]", rowIndex, nameOfTable));
}
if( GetValueByControlType($('#' + nameOfTable + 'Q_Q_R_O_' + rowIndex),nameOfTable,rowIndex)==TryParseInt('false', 'false') && operation == 'New' ){
