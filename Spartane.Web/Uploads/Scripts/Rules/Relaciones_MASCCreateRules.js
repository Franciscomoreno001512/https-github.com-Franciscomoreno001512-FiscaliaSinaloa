...
//BusinessRuleId:3098, Attribute:0, Operation:Object, Event:SCREENOPENING
if(operation == 'Update'){
if( GetValueByControlType($('#' + nameOfTable + 'Estatus' + rowIndex),nameOfTable,rowIndex)==TryParseInt('101', '101') && TryParseInt('2', '2')==EvaluaQuery("select GLOBAL[USERROLEID]",rowIndex, nameOfTable) && GetValueByControlType($('#' + nameOfTable + 'Resolucion_proc' + rowIndex),nameOfTable,rowIndex)==TryParseInt('null', 'null') ) { $('#divFecha_de_Validacion_solicitud').css('display', 'block');$('#divHora_de_Validacion_solicitud').css('display', 'block');$('#divUsuario_que_Valida_solicitud').css('display', 'block');$('#divresultado_solicitud').css('display', 'block'); SetRequiredToControl( $('#' + nameOfTable + 'Fecha_de_Validacion_solicitud' + rowIndex));SetRequiredToControl( $('#' + nameOfTable + 'Hora_de_Validacion_solicitud' + rowIndex));SetRequiredToControl( $('#' + nameOfTable + 'Usuario_que_Valida_solicitud' + rowIndex));SetRequiredToControl( $('#' + nameOfTable + 'resultado_solicitud' + rowIndex));} else {}
...
if(operation == 'Update'){
if( GetValueByControlType($('#' + nameOfTable + 'Estatus' + rowIndex),nameOfTable,rowIndex)!=TryParseInt('91', '91') && TryParseInt('2', '2')!=EvaluaQuery("select GLOBAL[USERROLEID]",rowIndex, nameOfTable) && GetValueByControlType($('#' + nameOfTable + 'Resultado_proc' + rowIndex),nameOfTable,rowIndex)==TryParseInt('null', 'null') ) { $('#divFecha_de_Validacion_proc').css('display', 'block');$('#divHora_de_Validacion_proc').css('display', 'block');$('#divUsuario_que_Valida_proc').css('display', 'block');$('#divResultado_proc').css('display', 'block');} else {}
...
if(operation == 'Update'){
if( TryParseInt('2', '2')==EvaluaQuery("SELECT GLOBAL[USERROLEID]",rowIndex, nameOfTable) && GetValueByControlType($('#' + nameOfTable + 'Estatus' + rowIndex),nameOfTable,rowIndex)==TryParseInt('101', '101') &&  EvaluaOperatorIn (GetValueByControlType($('#' + nameOfTable + 'Resolucion' + rowIndex),nameOfTable,rowIndex), EvaluaQuery("select STUFF(( select ',' + CAST(Clave AS nvarchar(max)) + '' from Resolucion_MASC where clave in (193000,194000) for XML PATH('') ), 1, 1, '')",rowIndex, nameOfTable) ) ) { $('#divFecha_de_Validacion_solicitud').css('display', 'none'); SetNotRequiredToControl( $('#' + nameOfTable + 'Fecha_de_Validacion_solicitud' + rowIndex));$('#divHora_de_Validacion_solicitud').css('display', 'none'); SetNotRequiredToControl( $('#' + nameOfTable + 'Hora_de_Validacion_solicitud' + rowIndex));$('#divUsuario_que_Valida_solicitud').css('display', 'none'); SetNotRequiredToControl( $('#' + nameOfTable + 'Usuario_que_Valida_solicitud' + rowIndex));$('#divresultado_solicitud').css('display', 'none'); SetNotRequiredToControl( $('#' + nameOfTable + 'resultado_solicitud' + rowIndex));$('#divmotivo_rechazo_solicitud').css('display', 'none'); SetNotRequiredToControl( $('#' + nameOfTable + 'motivo_rechazo_solicitud' + rowIndex)); DisabledControl($("#" + nameOfTable + "Fecha_de_Validacion_solicitud" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Fecha_de_Validacion_solicitud' + rowIndex));}DisabledControl($("#" + nameOfTable + "Hora_de_Validacion_solicitud" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Hora_de_Validacion_solicitud' + rowIndex));}DisabledControl($("#" + nameOfTable + "Usuario_que_Valida_solicitud" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Usuario_que_Valida_solicitud' + rowIndex));}DisabledControl($("#" + nameOfTable + "resultado_solicitud" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'resultado_solicitud' + rowIndex));}DisabledControl($("#" + nameOfTable + "motivo_rechazo_solicitud" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'motivo_rechazo_solicitud' + rowIndex));}} else {}

}
//BusinessRuleId:3561, Attribute:0, Operation:Object, Event:SCREENOPENING

//BusinessRuleId:3848, Attribute:0, Operation:Object, Event:SCREENOPENING
if(operation == 'Update'){
if( GetValueByControlType($('#' + nameOfTable + 'Estatus' + rowIndex),nameOfTable,rowIndex)==TryParseInt('99', '99') ) { DisabledControl($("#" + nameOfTable + "Clave" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Clave' + rowIndex));}DisabledControl($("#" + nameOfTable + "Numero_de_Expediente" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Numero_de_Expediente' + rowIndex));}DisabledControl($("#" + nameOfTable + "Numero_de_Procedimiento" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Numero_de_Procedimiento' + rowIndex));}DisabledControl($("#" + nameOfTable + "Requiere_cambiar_la_relacion" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Requiere_cambiar_la_relacion' + rowIndex));}DisabledControl($("#" + nameOfTable + "Motivo_de_Cambio" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Motivo_de_Cambio' + rowIndex));}DisabledControl($("#" + nameOfTable + "Observaciones" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Observaciones' + rowIndex));}DisabledControl($("#" + nameOfTable + "Descripcion" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Descripcion' + rowIndex));}DisabledControl($("#" + nameOfTable + "Fecha_de_Resolucion_solicitud" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Fecha_de_Resolucion_solicitud' + rowIndex));}DisabledControl($("#" + nameOfTable + "Hora_de_Resolucion_solicitud" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Hora_de_Resolucion_solicitud' + rowIndex));}DisabledControl($("#" + nameOfTable + "Usuario_que_Resuelve_solicitud" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Usuario_que_Resuelve_solicitud' + rowIndex));}DisabledControl($("#" + nameOfTable + "Resolucion" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Resolucion' + rowIndex));}DisabledControl($("#" + nameOfTable + "Tipo_de_Mecanismo" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Tipo_de_Mecanismo' + rowIndex));}DisabledControl($("#" + nameOfTable + "Observaciones_solicitud" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Observaciones_solicitud' + rowIndex));}DisabledControl($("#" + nameOfTable + "Fecha_de_Validacion_solicitud" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Fecha_de_Validacion_solicitud' + rowIndex));}DisabledControl($("#" + nameOfTable + "Hora_de_Validacion_solicitud" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Hora_de_Validacion_solicitud' + rowIndex));}DisabledControl($("#" + nameOfTable + "Usuario_que_Valida_solicitud" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Usuario_que_Valida_solicitud' + rowIndex));}DisabledControl($("#" + nameOfTable + "resultado_solicitud" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'resultado_solicitud' + rowIndex));}DisabledControl($("#" + nameOfTable + "motivo_rechazo_solicitud" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'motivo_rechazo_solicitud' + rowIndex));}DisabledControl($("#" + nameOfTable + "Fecha_de_Resolucion_proc" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Fecha_de_Resolucion_proc' + rowIndex));}DisabledControl($("#" + nameOfTable + "hora_resolucion_proc" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'hora_resolucion_proc' + rowIndex));}DisabledControl($("#" + nameOfTable + "usuario_resuelve_proc" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'usuario_resuelve_proc' + rowIndex));}DisabledControl($("#" + nameOfTable + "Resolucion_proc" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Resolucion_proc' + rowIndex));}DisabledControl($("#" + nameOfTable + "Observaciones_proc" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Observaciones_proc' + rowIndex));}DisabledControl($("#" + nameOfTable + "Fecha_de_Validacion_proc" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Fecha_de_Validacion_proc' + rowIndex));}DisabledControl($("#" + nameOfTable + "Hora_de_Validacion_proc" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Hora_de_Validacion_proc' + rowIndex));}DisabledControl($("#" + nameOfTable + "Usuario_que_Valida_proc" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Usuario_que_Valida_proc' + rowIndex));}DisabledControl($("#" + nameOfTable + "Resultado_proc" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Resultado_proc' + rowIndex));}DisabledControl($("#" + nameOfTable + "Motivo_de_Rechazo_proc" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Motivo_de_Rechazo_proc' + rowIndex));}DisabledControl($("#" + nameOfTable + "idRelacionOrigen" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'idRelacionOrigen' + rowIndex));}DisabledControl($("#" + nameOfTable + "Clave" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Clave' + rowIndex));}DisabledControl($("#" + nameOfTable + "Relaciones" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Relaciones' + rowIndex));}DisabledControl($("#" + nameOfTable + "Requerido" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Requerido' + rowIndex));}DisabledControl($("#" + nameOfTable + "Delito" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Delito' + rowIndex));}DisabledControl($("#" + nameOfTable + "Solicitante" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Solicitante' + rowIndex));}DisabledControl($("#" + nameOfTable + "Estatus" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Estatus' + rowIndex));}} else {}

}
//BusinessRuleId:3848, Attribute:0, Operation:Object, Event:SCREENOPENING

//BusinessRuleId:3857, Attribute:0, Operation:Object, Event:SCREENOPENING
if(operation == 'Update'){
if(  EvaluaOperatorIn (GetValueByControlType($('#' + nameOfTable + 'Estatus' + rowIndex),nameOfTable,rowIndex), EvaluaQuery("select STUFF((    select ',' + cast(Clave as nvarchar(9))+ ''   from Estatus_Solicitud where Clave in (93,94,95,97,98,100,101) for XML PATH('')  ), 1, 1, '')",rowIndex, nameOfTable) ) ) { DisabledControl($("#" + nameOfTable + "Fecha_de_Resolucion_solicitud" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Fecha_de_Resolucion_solicitud' + rowIndex));}DisabledControl($("#" + nameOfTable + "Hora_de_Resolucion_solicitud" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Hora_de_Resolucion_solicitud' + rowIndex));}DisabledControl($("#" + nameOfTable + "Usuario_que_Resuelve_solicitud" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Usuario_que_Resuelve_solicitud' + rowIndex));}DisabledControl($("#" + nameOfTable + "Resolucion" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Resolucion' + rowIndex));}DisabledControl($("#" + nameOfTable + "Tipo_de_Mecanismo" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Tipo_de_Mecanismo' + rowIndex));}DisabledControl($("#" + nameOfTable + "Observaciones_solicitud" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Observaciones_solicitud' + rowIndex));}} else {}
...
if(operation == 'Update'){
if( TryParseInt('3', '3')==EvaluaQuery("SELECT GLOBAL[USERROLEID]",rowIndex, nameOfTable) &&  EvaluaOperatorIn (GetValueByControlType($('#' + nameOfTable + 'Resolucion' + rowIndex),nameOfTable,rowIndex), EvaluaQuery("select STUFF((   select ',' + CAST(Clave AS nvarchar(max)) + '' from Resolucion_MASC where Resolucion_para_solicitud = 1 and Rechazo = 1 for XML PATH('')  ), 1, 1, '')",rowIndex, nameOfTable) ) && GetValueByControlType($('#' + nameOfTable + 'Estatus' + rowIndex),nameOfTable,rowIndex)==TryParseInt('91', '91') ) { EvaluaQuery("update Solicitud set Estatus = 101 where Clave = FLD[Numero_de_Expediente]", rowIndex, nameOfTable); EvaluaQuery("update Relaciones_MASC set Estatus = 101 where Clave = FLDD[lblClave]", rowIndex, nameOfTable);} else {}
...
if(operation == 'Update'){
if( TryParseInt('3', '3')==EvaluaQuery("select GLOBAL[USERROLEID]",rowIndex, nameOfTable) && GetValueByControlType($('#' + nameOfTable + 'Resolucion_proc' + rowIndex),nameOfTable,rowIndex)!=TryParseInt('null', 'null') &&  EvaluaOperatorIn (GetValueByControlType($('#' + nameOfTable + 'Estatus' + rowIndex),nameOfTable,rowIndex), EvaluaQuery("select STUFF((   select ',' + CAST(Clave AS nvarchar(max)) + '' from Estatus_Solicitud where clave not in (101) for XML PATH('')  ), 1, 1, '')",rowIndex, nameOfTable) ) ) { EvaluaQuery(" update Solicitud set Estatus = 101 where Clave = FLD[Numero_de_Expediente]", rowIndex, nameOfTable); EvaluaQuery(" update Relaciones_MASC set Estatus = 101 where Clave = FLDD[lblClave]", rowIndex, nameOfTable);} else {}
...
if(operation == 'Update'){
if( TryParseInt('3', '3')==EvaluaQuery("SELECT GLOBAL[USERROLEID]",rowIndex, nameOfTable) && GetValueByControlType($('#' + nameOfTable + 'Estatus' + rowIndex),nameOfTable,rowIndex)==TryParseInt('102', '102') &&  EvaluaOperatorIn (GetValueByControlType($('#' + nameOfTable + 'Resolucion' + rowIndex),nameOfTable,rowIndex), EvaluaQuery("select STUFF((   select ',' + CAST(Clave AS nvarchar(max)) + '' from Resolucion_MASC where clave  in (193000, 194000) for XML PATH('')  ), 1, 1, '')",rowIndex, nameOfTable) ) && GetValueByControlType($('#' + nameOfTable + 'Resolucion_proc' + rowIndex),nameOfTable,rowIndex)==TryParseInt('null', 'null') ) { EvaluaQuery("update Solicitud set Estatus = 93 where Clave = FLD[Numero_de_Expediente]", rowIndex, nameOfTable); EvaluaQuery("exec uspGeneraFolioRelacionesMASC FLDD[lblClave]", rowIndex, nameOfTable); EvaluaQuery("update Relaciones_MASC set Estatus = 93 where Clave = FLDD[lblClave]", rowIndex, nameOfTable);} else {}
...
if(operation == 'Update'){
if( TryParseInt('2', '2')==EvaluaQuery("select GLOBAL[USERROLEID]",rowIndex, nameOfTable) && GetValueByControlType($('#' + nameOfTable + 'Resolucion_proc' + rowIndex),nameOfTable,rowIndex)!=TryParseInt('null', 'null') && GetValueByControlType($('#' + nameOfTable + 'Resultado_proc' + rowIndex),nameOfTable,rowIndex)==TryParseInt('1', '1') ) { EvaluaQuery(" update Relaciones_MASC set Estatus = 99 where Clave = FLDD[lblClave]", rowIndex, nameOfTable);} else {}
...
//BusinessRuleId:3858, Attribute:2, Operation:Object, Event:AFTERSAVING
if(operation == 'New'){
 EvaluaQuery("update Relaciones_MASC set Descripcion = (select Descripcion from Detalle_de_Relaciones where Clave = FLD[idRelacionOrigen]) where Clave = FLDD[lblClave]", rowIndex, nameOfTable);
...
if(operation == 'Update'){
if( TryParseInt('2', '2')==EvaluaQuery("SELECT GLOBAL[USERROLEID]",rowIndex, nameOfTable) ) { EvaluaQuery("exec uspActualizaExpedienteCerradoMASC GLOBAL[SpartanOperationId]", rowIndex, nameOfTable);} else {}
