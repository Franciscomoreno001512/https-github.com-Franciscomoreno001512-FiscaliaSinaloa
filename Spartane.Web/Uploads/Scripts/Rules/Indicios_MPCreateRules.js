...
$('#Indicios_MPGuardarYNuevo').hide();
$('#Indicios_MPGuardarYCopia').hide();
$(document).ready(function () {
//NEWBUSINESSRULE_NONE//
});
function EjecutarValidacionesAlComienzo() {
//BusinessRuleId:2544, Attribute:0, Operation:Object, Event:SCREENOPENING
if(operation == 'New'){
...
//BusinessRuleId:2545, Attribute:0, Operation:Object, Event:SCREENOPENING
if(operation == 'New'){
...
//BusinessRuleId:2546, Attribute:2, Operation:Object, Event:AFTERSAVING
if(operation == 'New'){
 EvaluaQuery(" update Indicios_MP set expediente_mp = GLOBAL[SpartanOperationId] where clave=GLOBAL[keyvalueinserted]", rowIndex, nameOfTable);
