...
$("form#CreateRecepcion_de_Pago_MASC").on('change', '#Numero_de_Expediente', function () {
	if(operation == 'New'){
		nameOfTable='';
		rowIndex='';
	 	AsignarValor($('#' + nameOfTable + 'Numero_de_Pago' + rowIndex),EvaluaQuery("select COUNT(*) +1 from Recepcion_de_Pago_MASC where Numero_de_Expediente = FLD[Numero_de_Expediente]", rowIndex, nameOfTable));
	}
});



$("form#CreateRecepcion_de_Pago_MASC").on('change', '#Requerido', function () {
	if(operation == 'New'){
		nameOfTable='';
		rowIndex='';
	 	AsignarValor($('#' + nameOfTable + 'Numero_de_Pago' + rowIndex),EvaluaQuery("select COUNT(*) +1 from Recepcion_de_Pago_MASC where Numero_de_Expediente = FLD[Numero_de_Expediente] and Requerido = FLD[Requerido]", rowIndex, nameOfTable));
	}
});
...
$("form#CreateRecepcion_de_Pago_MASC").on('change', '#Pago_Completo', function () {
	nameOfTable='';
	rowIndex='';
if( GetValueByControlType($('#' + nameOfTable + 'Pago_Completo' + rowIndex),nameOfTable,rowIndex)==TryParseInt('false', 'false') ) { $('#divPago_Completo').css('display', 'block'); SetRequiredToControl( $('#' + nameOfTable + 'Pago_Completo' + rowIndex)); $('#divMotivo_para_no_entregar_pago_completo').css('display', 'block');} else { $('#divPago_Completo').css('display', 'none'); SetNotRequiredToControl( $('#' + nameOfTable + 'Pago_Completo' + rowIndex)); $('#divMotivo_para_no_entregar_pago_completo').css('display', 'none'); SetNotRequiredToControl( $('#' + nameOfTable + 'Motivo_para_no_entregar_pago_completo' + rowIndex)); SetNotRequiredToControl( $('#' + nameOfTable + 'Motivo_para_no_entregar_pago_completo' + rowIndex));}
});
...
//BusinessRuleId:2079, Attribute:0, Operation:Object, Event:SCREENOPENING
if(operation == 'New'){
...
if(operation == 'New'){
if( GetValueByControlType($('#' + nameOfTable + 'Pago_Completo' + rowIndex),nameOfTable,rowIndex)==TryParseInt('false', 'false') ) { $('#divPago_Completo').css('display', 'block'); SetRequiredToControl( $('#' + nameOfTable + 'Pago_Completo' + rowIndex)); $('#divMotivo_para_no_entregar_pago_completo').css('display', 'block'); SetRequiredToControl( $('#' + nameOfTable + 'Motivo_para_no_entregar_pago_completo' + rowIndex));} else { $('#divPago_Completo').css('display', 'none'); SetNotRequiredToControl( $('#' + nameOfTable + 'Pago_Completo' + rowIndex)); $('#divMotivo_para_no_entregar_pago_completo').css('display', 'none'); SetNotRequiredToControl( $('#' + nameOfTable + 'Motivo_para_no_entregar_pago_completo' + rowIndex)); SetNotRequiredToControl( $('#' + nameOfTable + 'Motivo_para_no_entregar_pago_completo' + rowIndex));}
