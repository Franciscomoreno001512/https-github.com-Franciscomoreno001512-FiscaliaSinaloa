...
if(operation == 'New'){
 $("a[href='#tabResolucion_de_Solicitud']").css('display', 'none'); $("a[href='#tabResolucion_de_Procedimiento']").css('display', 'none'); SetNotRequiredToControl( $('#' + nameOfTable + 'Usuario_que_Resuelve_Solicitud' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Resolucion_Solicitud' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Observaciones_Solicitud' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Fecha_de_Resolucion_Procedimiento' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Hora_de_Resolucion_Procedimiento' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Usuario_que_Resuelve_Procedimiento' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Resolucion_de_Procedimiento' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Observaciones_Procedimiento' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Fecha_de_Validacion_Procedimiento' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Hora_de_Validacion_Procedimiento' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Usuario_que_Valida_Procedimiento' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Resultado_Procedimiento' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Motivo_de_Rechazo_Procedimiento' + rowIndex)); SetNotRequiredToControl( $('#' + nameOfTable + 'Fecha_Validacion' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Hora_Validacion' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Usuario_que_Valida' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Autoriza_Cierre_de_Expediente' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Motivo_de_Rechazo_Solicitud' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Usuario_que_Resuelve_Solicitud' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Resolucion_Solicitud' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Observaciones_Solicitud' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Fecha_de_Resolucion_Procedimiento' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Hora_de_Resolucion_Procedimiento' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Usuario_que_Resuelve_Procedimiento' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Resolucion_de_Procedimiento' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Observaciones_Procedimiento' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Fecha_de_Validacion_Procedimiento' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Hora_de_Validacion_Procedimiento' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Usuario_que_Valida_Procedimiento' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Resultado_Procedimiento' + rowIndex));SetNotRequiredToControl( $('#' + nameOfTable + 'Motivo_de_Rechazo_Procedimiento' + rowIndex));
