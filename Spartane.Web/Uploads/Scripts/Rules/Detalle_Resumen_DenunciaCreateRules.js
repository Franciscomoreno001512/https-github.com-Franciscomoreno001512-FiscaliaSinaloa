...
//NEWBUSINESSRULE_NONE//
	...
	if(operation == 'Update'){
        if( TryParseInt('107', '107')==EvaluaQuery("SELECT GLOBAL[USERROLEID]",rowIndex, nameOfTable) ){
            $("#Detalle_Resumen_DenunciaGuardar").hide();
        }
    }

	if(operation == 'New'){
		if( EvaluaQuery("select top 1 generar from Detalle_Resumen_Denuncia where Modulo_Atencion_Inicial = GLOBAL[SpartanOperationId] order by clave desc",rowIndex, nameOfTable)==TryParseInt('2', '2') ) 
		{
			 alert(DecodifyText('Ya cuenta con carpeta de investigación generada.', rowIndex, nameOfTable));
			 $("#Detalle_Resumen_DenunciaGuardar").hide();
		} 
		else {}
	}
...
if(operation == 'New'){
 DisabledControl($("#" + nameOfTable + "Generar" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Generar' + rowIndex));}DisabledControl($("#" + nameOfTable + "Numero_Generado" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Numero_Generado' + rowIndex));}DisabledControl($("#" + nameOfTable + "Numero_de_Oficio" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Numero_de_Oficio' + rowIndex));}
...
//BusinessRuleId:4381, Attribute:0, Operation:Object, Event:SCREENOPENING
if(operation == 'Update'){
if( TryParseInt('107', '107')==EvaluaQuery("SELECT GLOBAL[USERROLEID]",rowIndex, nameOfTable) ) { DisabledControl($("#" + nameOfTable + "Clave" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Clave' + rowIndex));}DisabledControl($("#" + nameOfTable + "Modulo_Atencion_Inicial" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Modulo_Atencion_Inicial' + rowIndex));}DisabledControl($("#" + nameOfTable + "Probable_Responsable" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Probable_Responsable' + rowIndex));}DisabledControl($("#" + nameOfTable + "Generado" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Generado' + rowIndex));}DisabledControl($("#" + nameOfTable + "Fecha_de_registro" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Fecha_de_registro' + rowIndex));}DisabledControl($("#" + nameOfTable + "Hora_de_registro" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Hora_de_registro' + rowIndex));}DisabledControl($("#" + nameOfTable + "Delito" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Delito' + rowIndex));}DisabledControl($("#" + nameOfTable + "Victima" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Victima' + rowIndex));}DisabledControl($("#" + nameOfTable + "Relacion" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Relacion' + rowIndex));}DisabledControl($("#" + nameOfTable + "Hechos" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Hechos' + rowIndex));}DisabledControl($("#" + nameOfTable + "Archivo_Descargado" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Archivo_Descargado' + rowIndex));}DisabledControl($("#" + nameOfTable + "Documento" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Documento' + rowIndex));}DisabledControl($("#" + nameOfTable + "Usuario_que_registra" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Usuario_que_registra' + rowIndex));}DisabledControl($("#" + nameOfTable + "Archivo" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Archivo' + rowIndex));}DisabledControl($("#" + nameOfTable + "Generar" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Generar' + rowIndex));}DisabledControl($("#" + nameOfTable + "Numero_Generado" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Numero_Generado' + rowIndex));}DisabledControl($("#" + nameOfTable + "Numero_de_Oficio" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Numero_de_Oficio' + rowIndex));}DisabledControl($("#" + nameOfTable + "Expediente_MP" + rowIndex), ("true" == "true"));if ('true'=='true'){SetNotRequiredToControl( $('#' + nameOfTable + 'Expediente_MP' + rowIndex));}} else {}
...
//BusinessRuleId:4444, Attribute:2, Operation:Object, Event:BEFORESAVING
if(operation == 'New'){
	if( EvaluaQuery("select top 1 generar from Detalle_Resumen_Denuncia where Modulo_Atencion_Inicial = GLOBAL[SpartanOperationId] order by clave desc",rowIndex, nameOfTable)==TryParseInt('2', '2') ) { alert(DecodifyText(' No se permite generar mas expedientes.', rowIndex, nameOfTable));
...
//BusinessRuleId:4391, Attribute:2, Operation:Object, Event:BEFORESAVING
if(operation == 'New'){
if( GetValueByControlType($('#' + nameOfTable + 'Probable_Responsable' + rowIndex),nameOfTable,rowIndex)==TryParseInt('null', 'null') || GetValueByControlType($('#' + nameOfTable + 'Delito' + rowIndex),nameOfTable,rowIndex)==TryParseInt('null', 'null') || GetValueByControlType($('#' + nameOfTable + 'Victima' + rowIndex),nameOfTable,rowIndex)==TryParseInt('null', 'null') || GetValueByControlType($('#' + nameOfTable + 'Relacion' + rowIndex),nameOfTable,rowIndex)==TryParseInt('null', 'null') || GetValueByControlType($('#' + nameOfTable + 'Hechos' + rowIndex),nameOfTable,rowIndex)==TryParseInt('null', 'null') ) { alert(DecodifyText('Datos mínimos para generar Número de Expediente no válidos.', rowIndex, nameOfTable));
result=false;} else { AsignarValor($('#' + nameOfTable + 'Numero_de_Oficio' + rowIndex),EvaluaQuery("EXEC uspGeneraFolioAT 3,NULL,GLOBAL[SpartanOperationId]", rowIndex, nameOfTable));}

}
//BusinessRuleId:4391, Attribute:2, Operation:Object, Event:BEFORESAVING

//BusinessRuleId:4717, Attribute:2, Operation:Object, Event:BEFORESAVING
if(operation == 'Update'){
if( GetValueByControlType($('#' + nameOfTable + 'Probable_Responsable' + rowIndex),nameOfTable,rowIndex)==TryParseInt('null', 'null') || GetValueByControlType($('#' + nameOfTable + 'Delito' + rowIndex),nameOfTable,rowIndex)==TryParseInt('null', 'null') || GetValueByControlType($('#' + nameOfTable + 'Victima' + rowIndex),nameOfTable,rowIndex)==TryParseInt('null', 'null') || GetValueByControlType($('#' + nameOfTable + 'Relacion' + rowIndex),nameOfTable,rowIndex)==TryParseInt('null', 'null') || GetValueByControlType($('#' + nameOfTable + 'Hechos' + rowIndex),nameOfTable,rowIndex)==TryParseInt('null', 'null') ) { alert(DecodifyText('Datos mínimos para generar Número de Expediente no válidos', rowIndex, nameOfTable));
...
function OpenFormat() {
    ...
    var closeAfterLoaded = "TRUE";
    var keyinsert = EvaluaQuery("select GLOBAL[KeyValueInserted]");// Recordid 
    var fid = EvaluaQuery(" usp_getIdFormatoFromDocumento  " + $('#Documento').val() + "");
    var role = EvaluaQuery("SELECT GLOBAL[USERROLEID]");
    OpenPrintFormats(keyinsert, role, "", false, "45018", fid, closeAfterLoaded);
