...
namespace Spartane.Core.Domain.Circunstancia_Defuncion
{
    /// <summary>
    /// Circunstancia_Defuncion table
    /// </summary>
    public class Circunstancia_Defuncion: BaseEntity
    {
	...
	public class Circunstancia_Defuncion_Datos_Generales
    {
                public short Clave { get; set; }
        public string Descripcion { get; set; }
        public short? Tipo_Defuncion { get; set; }
