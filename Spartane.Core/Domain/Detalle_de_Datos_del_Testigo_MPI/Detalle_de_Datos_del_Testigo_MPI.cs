...
namespace Spartane.Core.Domain.Detalle_de_Datos_del_Testigo_MPI
{
    /// <summary>
    /// Detalle_de_Datos_del_Testigo_MPI table
    /// </summary>
    public class Detalle_de_Datos_del_Testigo_MPI: BaseEntity
    {
        ...
        public DateTime? Fecha_de_Nacimento_del_Tutor { get; set; }
        ...
        [ForeignKey("Tipo_del_Lugar_del_Hecho")]
        public virtual Spartane.Core.Domain.Lugar_Tipo.Lugar_Tipo Tipo_del_Lugar_del_Hecho_Lugar_Tipo { get; set; }
	...
	public class Detalle_de_Datos_del_Testigo_MPI_Datos_Generales
    {
                public int Clave { get; set; }
        public string Nombre { get; set; }
        public string Apellido_Paterno { get; set; }
	...
	public class Detalle_de_Datos_del_Testigo_MPI__Datos_del_Tutor
    {
                public int Clave { get; set; }
        public string Nombre_del_Tutor { get; set; }
        public string Apellido_Paterno_del_Tutor { get; set; }
	...
	public class Detalle_de_Datos_del_Testigo_MPI_Datos_de_los_Hechos
    {
                public int Clave { get; set; }
        public string Narrativa_del_Testigo { get; set; }
        public string Titulo_del_Hecho { get; set; }
