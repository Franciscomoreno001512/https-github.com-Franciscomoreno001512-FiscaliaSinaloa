...
namespace Spartane.Core.Domain.Otros_Domicilios_Requeridos_MASC
{
    /// <summary>
    /// Otros_Domicilios_Requeridos_MASC table
    /// </summary>
    public class Otros_Domicilios_Requeridos_MASC: BaseEntity
    {
	...
	public class Otros_Domicilios_Requeridos_MASC_Datos_Generales
    {
                public int Clave { get; set; }
        public int? Requerido { get; set; }
        public int? Estado { get; set; }
