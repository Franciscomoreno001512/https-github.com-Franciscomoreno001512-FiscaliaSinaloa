...
{
    /// <summary>
    /// Clasificacion_en_Orden_de_Resultado table
    /// </summary>
    public class Clasificacion_en_Orden_de_Resultado: BaseEntity
    {
	...
	public class Clasificacion_en_Orden_de_Resultado_Datos_Generales
    {
                public int Clave { get; set; }
        public string Descripcion { get; set; }
        public int? Vigencia { get; set; }
