...
namespace Spartane.Core.Domain.Detalle_de_Requerido_en_Invitaciones
{
    /// <summary>
    /// Detalle_de_Requerido_en_Invitaciones table
    /// </summary>
    public class Detalle_de_Requerido_en_Invitaciones: BaseEntity
    {
	...
	public class Detalle_de_Requerido_en_Invitaciones_Datos_Generales
    {
                public int Clave { get; set; }
        public int? Solicitud { get; set; }
        public int? Nombre { get; set; }
