...
{
    /// <summary>
    /// Detalle_de_Fotos_de_Emergencia_CC table
    /// </summary>
    public class Detalle_de_Fotos_de_Emergencia_CC: BaseEntity
    {
	...
	public class Detalle_de_Fotos_de_Emergencia_CC_Datos_Generales
    {
                public int Clave { get; set; }
        public int? Cadena_de_Custodia { get; set; }
        public DateTime? Fecha { get; set; }
