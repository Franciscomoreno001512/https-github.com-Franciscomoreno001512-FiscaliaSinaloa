...
namespace Spartane.Core.Domain.Detalle_de_Solicitud_Representante_Legal
{
    /// <summary>
    /// Detalle_de_Solicitud_Representante_Legal table
    /// </summary>
    public class Detalle_de_Solicitud_Representante_Legal: BaseEntity
    {
        ...
        [ForeignKey("Colonia_")]
        public virtual Spartane.Core.Domain.Colonia.Colonia Colonia__Colonia { get; set; }
        [ForeignKey("Colonia")]
        public virtual Spartane.Core.Domain.Colonia.Colonia Colonia_Colonia { get; set; }

    }
	
	public class Detalle_de_Solicitud_Representante_Legal_Datos_Generales
    {
                public int Clave { get; set; }
        public int? idRegistroAT { get; set; }
        public int? idRegistroUI { get; set; }
