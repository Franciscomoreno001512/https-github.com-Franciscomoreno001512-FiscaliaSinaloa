...
namespace Spartane.Core.Domain.Detalle_Medios_Prueba_Victima
{
    /// <summary>
    /// Detalle_Medios_Prueba_Victima table
    /// </summary>
    public class Detalle_Medios_Prueba_Victima: BaseEntity
    {
	...
	public class Detalle_Medios_Prueba_Victima_Datos_Generales
    {
                public int Clave { get; set; }
        public int? Proceso_Penal { get; set; }
        public string Medio_de_Prueba_Presentado { get; set; }
