...
namespace Spartane.Core.Domain.Carga_de_Documentos_Lectura_de_Derechos
{
    /// <summary>
    /// Carga_de_Documentos_Lectura_de_Derechos table
    /// </summary>
    public class Carga_de_Documentos_Lectura_de_Derechos: BaseEntity
    {
	...
	public class Carga_de_Documentos_Lectura_de_Derechos_Datos_Generales
    {
                public int Folio { get; set; }
        public string Nombre { get; set; }
        public string Descripcion { get; set; }
